...
var warnMessage = function warnMessage(error, behavior) {
  return (
    "\n  gatsby-plugin-feed was initialized in gatsby-config.js without a " +
    error +
    ".\n  This means that the plugin will use " +
    behavior +
    ", which may not match your use case.\n  This behavior will be removed in the next major release of gatsby-plugin-feed.\n  For more info, check out: https://gatsby.dev/adding-rss-feed\n"
  );
...
var serialize = function serialize(_ref) {
  ...
  return allMarkdownRemark.edges.map(function(edge) {
    return (0, _extends2.default)(
      (0, _extends2.default)({}, edge.node.frontmatter),
      {},
      {
                ...
                if (!normalized.feeds) {
                  reporter.warn(
                    reporter.stripIndent(
                      warnMessage(
                        "feeds option",
                        "the internal RSS feed creation"
                      )
                    )
                  );
                } else if (
                  normalized.feeds.some(function(feed) {
          ...
          switch ((_context2.prev = _context2.next)) {
            case 0:
              ...
              options = (0, _extends2.default)(
                (0, _extends2.default)({}, _internals.defaultOptions),
                pluginOptions
              );
              _context2.next = 4;
            ...
            case 6:
              ...
              _context2.next = 12;
              return (0, _internals.runQuery)(graphql, feed.query).then(
                function(result) {
            ...
            case 13:
              (_options$feed = (0, _extends2.default)(
                (0, _extends2.default)({}, options),
                feed
              )),
                (setup = _options$feed.setup),
                (locals = (0,
                _objectWithoutPropertiesLoose2.default)(_options$feed, [
                  "setup"
                ]));
              serializer =
            ...
            case 17:
              rssFeed = _context2.sent.reduce(function(merged, item) {
                merged.item(item);
                return merged;
