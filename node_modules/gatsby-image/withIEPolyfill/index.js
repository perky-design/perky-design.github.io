...
var ImageWithIEPolyfill = /*#__PURE__*/ (function(_Component) {
  ...
  function ImageWithIEPolyfill() {
    ...
    (0, _defineProperty2.default)(
      ...
      "imageRef",
      _this.props.innerRef || (0, _react.createRef)()
    );
    (0, _defineProperty2.default)(
      (0, _assertThisInitialized2.default)(_this),
      "placeholderRef",
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (
      ...
      Promise.resolve()
        .then(function() {
          return (0,
          _interopRequireWildcard2.default)(require("object-fit-images"));
        })
        .then(function(_ref) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/ _react.default.createElement(
      ...
      (0, _extends2.default)(
        ...
        props,
        {
          imgStyle: (0, _extends2.default)(
            (0, _extends2.default)({}, props.imgStyle),
            polyfillStyle
          ),
          placeholderStyle: (0, _extends2.default)(
            (0, _extends2.default)({}, props.placeholderStyle),
            polyfillStyle
          )
        }
      )
