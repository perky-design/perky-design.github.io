...
module.exports = function(getDescriptors, t) {
	...
	t.test(
		"works with Object.prototype poisoned setter",
		...
		function(st) {
			...
			try {
				...
				hasOwnNamesBug = true;
				st.comment(
					"SKIP: this engine has a bug with Object.getOwnPropertyNames: it can not handle a throwing setter on Object.prototype."
				);
			}
	...
	t.test("gets Symbol descriptors too", { skip: !supportsSymbols }, function(
		st
	) {
	...
	t.test(
		...
		function(st) {
			...
			st.deepEqual(
				getDescriptors(proxy),
				{ foo: fooDescriptor },
				"object has no descriptors"
			);
			st.end();
		}
	);
