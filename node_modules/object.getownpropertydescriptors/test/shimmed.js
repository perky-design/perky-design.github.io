...
test("shimmed", function(t) {
	t.equal(
		...
		1,
		"Object.getOwnPropertyDescriptors has a length of 1"
	);
	t.test("Function name", { skip: !functionsHaveNames }, function(st) {
		st.equal(
			Object.getOwnPropertyDescriptors.name,
			"getOwnPropertyDescriptors",
			'Object.getOwnPropertyDescriptors has name "getOwnPropertyDescriptors"'
		);
		st.end();
	});
	...
	t.test(
		...
		function(et) {
			et.equal(
				false,
				isEnumerable.call(Object, "getOwnPropertyDescriptors"),
				"Object.getOwnPropertyDescriptors is not enumerable"
			);
			et.end();
		}
	);
