...
type GetPluginFuncArrValues<PluginFuncArr> =
  ...
  PluginFuncArr extends ReadonlyArray<infer F>
    ? F extends () => infer Q // Get the plugin value, may be ill-formed or well-formed
      ? GetPluginVal<Q> // This should never be reached
      : undefined
    : undefined;
...
type GetPluginFuncArrConsts<PluginFuncArr> =
  // Given an array of types infer `Q` (Q should be the type value)
  PluginFuncArr extends ReadonlyArray<infer F>
    ? F extends () => infer Q // Get the plugin constants, may be ill-formed or well-formed
      ? GetPluginConst<Q> // This should never be reached
      : undefined
    : undefined;
...
type GetPluginFuncArrEncoders<PluginFuncArr> =
  // Given an array of types infer `Q` (Q should be the type value)
  PluginFuncArr extends ReadonlyArray<infer F>
    ? F extends () => infer Q // Get the plugin encoders, may be ill-formed or well-formed
      ? GetPluginEncoders<Q> // This should never be reached
      : undefined
    : undefined;
...
type GetPluginFuncArrDecoders<PluginFuncArr> =
  // Given an array of types infer `Q` (Q should be the type value)
  PluginFuncArr extends ReadonlyArray<infer F>
    ? F extends () => infer Q // Get the plugin decoders, may be ill-formed or well-formed
      ? GetPluginDecoders<Q> // This should never be reached
      : undefined
    : undefined;
