...
var L = m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,
  ca = L[11],
  M = L[12],
  da = m.unstable_batchedUpdates,
  N = q.IsSomeRendererActing,
  O = "function" === typeof n.unstable_flushAllWithoutAsserting,
  P =
    n.unstable_flushAllWithoutAsserting ||
    function() {
      for (var a = !1; ca(); ) a = !0;
      return a;
    };
...
var R = 0,
  S = !1,
  ea = m.findDOMNode,
  T = m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,
  fa = T[0],
  U = T[4],
  ha = T[5],
  ia = T[6],
...
function na(a) {
  return function(b, c) {
    if (k.isValidElement(b)) throw Error(p(228));
...
function oa(a, b) {
  return function(c, e) {
    ...
    g(d, e);
    Y.isDOMComponent(c)
      ? ((c = ea(c)), (d.target = c), V(b, 1, document, d))
      : c.tagName && ((d.target = c), V(b, 1, document, d));
  };
}
[
  ["abort", "abort"],
