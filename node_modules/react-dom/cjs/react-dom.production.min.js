...
function Oc(a, b, c, d, e) {
  switch (b) {
    ...
    case "gotpointercapture":
      return (
        (f = e.pointerId), Fc.set(f, Mc(Fc.get(f) || null, a, b, c, d, e)), !0
      );
  }
  return !1;
}
...
function Uc(a, b) {
  a.blockedOn === b &&
    ((a.blockedOn = null),
    zc ||
      ((zc = !0), r.unstable_scheduleCallback(r.unstable_NormalPriority, Tc)));
}
function Vc(a) {
  function b(b) {
    return Uc(b, a);
          ...
          case jj:
            if (1073741823 !== lj && null !== nj) {
              ...
              0 >= d
                ...
                : ((e = g.busyDelayMs | 0),
                  (f =
                    $f() - (10 * (1073741821 - f) - (g.timeoutMs | 0 || 5e3))),
                  (d = f <= e ? 0 : e + d - f));
              if (10 < d) {
                xi(a, c);
                a.timeoutHandle = Hd(Jj.bind(null, a), d);
    ...
    if (
      ...
      null !== h &&
        ...
        "selectionStart" in q
          ...
          : ((w =
              ((B = q.ownerDocument || document) && B.defaultView) || window),
            w.getSelection &&
              ((w = w.getSelection()),
...
function Ug(a, b, c, d, e, f) {
  ...
  if ("function" === typeof a) bi(a) && (g = 1);
    ...
    a: switch (a) {
      ...
      case ib:
        return (
          (a = Sh(19, c, b, e)), (a.elementType = ib), (a.expirationTime = f), a
        );
      default:
