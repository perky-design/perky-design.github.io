...
function t(a) {
  ...
  if (Array.isArray(b)) throw Error(m(103));
  a.currentTarget = b ? r(c) : null;
  b = b ? b(a) : null;
...
function z(a, b, c) {
  if ((b = w(a, c.dispatchConfig.phasedRegistrationNames[b])))
...
function B(a) {
  if (a && a.dispatchConfig.registrationName) {
    ...
    if (b && a && a.dispatchConfig.registrationName) {
      var c = w(b, a.dispatchConfig.registrationName);
      c &&
...
function da(a) {
  ...
  c
    ...
    : ((c = {
        ...
        currentTimeStamp: Q(a),
        previousPageX: a.pageX,
        previousPageY: a.pageY,
        previousTimeStamp: Q(a)
      }),
      (O[b] = c));
  P.mostRecentTimeStamp = Q(a);
}
function ea(a) {
  var b = O[R(a)];
  b &&
...
var S = {
  recordTouchTrack: function(a, b) {
    if (I(a)) b.changedTouches.forEach(ea);
    else if (H(a))
      b.changedTouches.forEach(da),
        (P.numberActiveTouches = b.touches.length),
        1 === P.numberActiveTouches &&
          (P.indexOfSingleActiveTouch = b.touches[0].identifier);
    else if (
      J(a) &&
      ...
      for (a = 0; a < O.length; a++)
        if (((b = O[a]), null != b && b.touchActive)) {
          P.indexOfSingleActiveTouch = a;
          break;
        }
  },
  touchHistory: P
...
var Y = {
    ...
    responderEnd: { registrationName: "onResponderEnd", dependencies: N },
    responderRelease: {
    ...
    extractEvents: function(a, b, c, f) {
      ...
      if (
        ...
        if (U)
          b: {
            var e = U;
            for (var g = 0, p = e; p; p = u(p)) g++;
            p = 0;
            for (var M = b; M; M = u(M)) p++;
            for (; 0 < g - p; ) (e = u(e)), g--;
            for (; 0 < p - g; ) (b = u(b)), p--;
            for (; g--; ) {
        ...
        if (d && d !== U)
          if (
            ((e = G.getPooled(Y.responderGrant, d, c, f)),
            (e.touchHistory = S.touchHistory),
            y(e, B),
            (b = !0 === t(e)),
            U)
            ...
            if (
              ((g = G.getPooled(Y.responderTerminationRequest, U, c, f)),
              (g.touchHistory = S.touchHistory),
              y(g, B),
              (p = !g._dispatchListeners || t(g)),
              g.isPersistent() || g.constructor.release(g),
              p)
            ) {
              g = G.getPooled(Y.responderTerminate, U, c, f);
              g.touchHistory = S.touchHistory;
              y(g, B);
              var l = T(l, [e, g]);
              W(d, b);
            } else
              (d = G.getPooled(Y.responderReject, d, c, f)),
  ...
  Z = h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,
  ha = Z[3],
  ia = Z[0],
  ja = Z[1];
n = Z[2];
