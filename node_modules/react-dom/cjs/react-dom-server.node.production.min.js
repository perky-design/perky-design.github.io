...
var u = "function" === typeof Symbol && Symbol.for,
  ...
  la = u ? Symbol.for("react.block") : 60121,
  ma = u ? Symbol.for("react.fundamental") : 60117,
  na = u ? Symbol.for("react.scope") : 60119;
function oa(a) {
  if (-1 === a._status) {
    a._status = 0;
    var b = a._ctor;
...
F[15] = 0;
var ra = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,
  sa = Object.prototype.hasOwnProperty,
  ta = {},
  ua = {};
function va(a) {
  if (sa.call(ua, a)) return !0;
  if (sa.call(ta, a)) return !1;
  if (ra.test(a)) return (ua[a] = !0);
  ta[a] = !0;
  return !1;
}
function wa(a, b, c, d) {
...
function xa(a, b, c, d) {
  if (null === b || "undefined" === typeof b || wa(a, b, c, d)) return !0;
  if (d) return !1;
  if (null !== c)
    switch (c.type) {
      case 3:
...
var Pa = /([A-Z])/g,
  ...
  Ra = D.ReactCurrentDispatcher,
  Sa = { listing: !0, pre: !0, textarea: !0 },
  Ta = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,
  Ua = {},
  Va = {};
function Wa(a) {
...
function Za(a, b) {
  if (void 0 === a) throw Error(r(152, C(b) || "Component"));
}
function $a(a, b, c) {
  function d(d, h) {
    ...
    if (e) {
      if (
        ...
        var x = h.getDerivedStateFromProps.call(null, d.props, e.state);
        null != x && (e.state = k({}, e.state, x));
      }
    } else if (
      ((O = {}),
      (e = h(d.props, f, l)),
      ...
      if (
        ...
        if (t && 1 === l.length) e.state = l[0];
          ...
          for (t = t ? 1 : 0; t < l.length; t++) {
            var q = l[t];
            q = "function" === typeof q ? q.call(e, x, d.props, f) : q;
            null != q && (y ? ((y = !1), (x = k({}, x, q))) : k(x, q));
          }
          e.state = x;
        }
      } else p = null;
    ...
    if (
      ...
      for (var T in A) if (!(T in d)) throw Error(r(108, C(h) || "Unknown", T));
    }
    A && (b = k({}, b, A));
  }
...
var ab = (function() {
      ...
      for (var h = [""], p = !1; h[0].length < a; ) {
        ...
        if (p || e.childIndex >= e.children.length) {
          ...
          var l = e.children[e.childIndex++],
            x = "";
          try {
            x += this.render(l, e.context, e.domNamespace);
          } catch (t) {
    ...
    if ("object" === typeof c && null !== c)
      switch (c.$$typeof) {
        ...
        case ma:
          throw Error(r(338));
        case ka:
          switch (((c = a.type), oa(c), c._status)) {
            case 1:
              return (
  ...
  b.renderDOM = function(a, b, f) {
    ...
    f === Ka.html && La(c);
    if (!Ua.hasOwnProperty(c)) {
      if (!Ta.test(c)) throw Error(r(65, c));
      Ua[c] = !0;
    }
    var d = a.props;
    if ("input" === c)
    ...
    if ((g = d)) {
      if (Na[c] && (null != g.children || null != g.dangerouslySetInnerHTML))
        throw Error(r(137, c, ""));
          ...
          if ("style" === z) {
            ...
            for (n in l)
              if (l.hasOwnProperty(n)) {
                ...
                if (null != q) {
                  if (y) var A = n;
                  else if (((A = n), Va.hasOwnProperty(A))) A = Va[A];
                  else {
                    var T = A.replace(Pa, "-$1")
                      .toLowerCase()
                      .replace(Qa, "-ms-");
                    A = Va[A] = T;
                  }
