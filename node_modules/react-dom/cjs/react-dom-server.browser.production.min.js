...
var $a = (function() {
    function a(a, b) {
      l.isValidElement(a)
        ? a.type !== u
          ? (a = [a])
          : ((a = a.props.children), (a = l.isValidElement(a) ? [a] : Z(a)))
        : (a = Z(a));
      a = {
        type: null,
    ...
    b.render = function(a, b, f) {
      ...
      if ("object" === typeof c && null !== c)
        switch (c.$$typeof) {
          ...
          case ia:
            return (
              (a = [l.createElement(c.type, k({ ref: a.ref }, a.props))]),
              this.stack.push({
                type: null,
                domNamespace: f,
                children: a,
          ...
          case ja:
            switch (((c = a.type), na(c), c._status)) {
              case 1:
                return (
                  (a = [
                    l.createElement(c._result, k({ ref: a.ref }, a.props))
                  ]),
                  this.stack.push({
                    type: null,
                    domNamespace: f,
    ...
    b.renderDOM = function(a, b, f) {
      ...
      if ((h = d)) {
        if (Ma[c] && (null != h.children || null != h.dangerouslySetInnerHTML))
          throw Error(q(137, c, ""));
        ...
        if (null != h.style && "object" !== typeof h.style)
          throw Error(q(62, ""));
      }
      h = d;
      ...
      for (z in h)
        if (Wa.call(h, z)) {
          ...
          if (null != m) {
              ...
              for (n in m)
                if (m.hasOwnProperty(n)) {
                  ...
                  if (null != p) {
                    ...
                    r = n;
                    y =
                      null == p || "boolean" === typeof p || "" === p
                        ? ""
                        : y ||
                          "number" !== typeof p ||
                          0 === p ||
                          (Y.hasOwnProperty(r) && Y[r])
                        ? ("" + p).trim()
                        : p + "px";
                    w += y;
                    r = ";";
            ...
            n = null;
            b: if (((y = c), (p = h), -1 === y.indexOf("-")))
              y = "string" === typeof p.is;
            else
              switch (y) {
                case "annotation-xml":
                case "color-profile":
