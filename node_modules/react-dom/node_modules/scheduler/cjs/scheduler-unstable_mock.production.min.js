      ...
      a: for (var d = 0, e = a.length; d < e; ) {
        ...
        if (void 0 !== v && 0 > A(v, c))
          void 0 !== y && 0 > A(y, v)
            ? ((a[d] = y), (a[w] = c), (d = w))
            : ((a[d] = v), (a[u] = c), (d = u));
        else if (void 0 !== y && 0 > A(y, c)) (a[d] = y), (a[w] = c), (d = w);
        else break a;
      }
    }
    return b;
...
function L(a) {
  for (var b = B(E); null !== b; ) {
    if (null === b.callback) C(E);
    else if (b.startTime <= a) C(E), (b.sortIndex = b.expirationTime), z(D, b);
    else break;
    b = B(E);
  }
}
...
exports.unstable_scheduleCallback = function(a, b, c) {
  ...
  e > d
    ? ((a.sortIndex = e),
      ...
      null === B(D) &&
        a === B(E) &&
        (K ? ((h = null), (k = -1)) : (K = !0), (h = M), (k = f + (e - d))))
    : ((a.sortIndex = c), z(D, a), J || I || ((J = !0), (g = N)));
  return a;
};
exports.unstable_shouldYield = function() {
  ...
  return (
    (b !== G &&
      ...
      null !== b.callback &&
      b.startTime <= a &&
      b.expirationTime < G.expirationTime) ||
    t()
  );
};
