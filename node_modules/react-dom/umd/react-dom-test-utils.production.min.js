...
(function(k, n) {
  "object" === typeof exports && "undefined" !== typeof module
    ...
    : ((k = k || self), (k.ReactTestUtils = n(k.React, k.ReactDOM)));
})(this, function(k, n) {
  function l(a) {
    for (
  ...
  function R(a) {
    ...
    for (var c = a, e = b; ; ) {
      ...
      if (c.alternate !== e) throw Error(l(190));
    }
  ...
  function x(a) {
    ...
    var b = q[a],
      c;
    for (c in b) if (b.hasOwnProperty(c) && c in I) return (A[a] = b[c]);
    return a;
  }
  function U(a) {
    if (null === y)
      try {
        ...
        y = (module && module[b])("timers").setImmediate;
      } catch (c) {
        y = function(a) {
  ...
  function p(a, b) {
    if (a && !a._reactInternalFiber) {
      ...
      a = Array.isArray(a)
        ...
        : c;
      throw Error(l(286, b, a));
    }
  }
  function W(a) {
    return function(b, c) {
      if (k.isValidElement(b)) throw Error(l(228));
      if (f.isCompositeComponent(b)) throw Error(l(229));
      var e = L[a],
        d = new K();
      d.target = b;
      ...
      h.persist();
      t(h, c);
      e.phasedRegistrationNames ? Y(h) : Z(h);
  ...
  function da(a, b) {
    return function(c, e) {
      ...
      t(d, e);
      f.isDOMComponent(c)
        ? ((c = ea(c)), (d.target = c), M(b, 1, document, d))
        : c.tagName && ((d.target = c), M(b, 1, document, d));
    };
  }
  var t = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,
    h = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  h.hasOwnProperty("ReactCurrentDispatcher") ||
    (h.ReactCurrentDispatcher = { current: null });
  h.hasOwnProperty("ReactCurrentBatchConfig") ||
    (h.ReactCurrentBatchConfig = { suspense: null });
  t(r.prototype, {
  ...
  C = x("animationend");
  var fa = x("animationiteration"),
    ha = x("animationstart"),
    ia = x("transitionend"),
    y = null,
    N =
      k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Scheduler
        .unstable_flushAllWithoutAsserting,
    O = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,
    ja = O[11],
    D = O[12],
    ka = n.unstable_batchedUpdates,
    E = h.IsSomeRendererActing,
    P = "function" === typeof N,
    B =
      N ||
      function() {
    ...
    Q = !1,
    ea = n.findDOMNode;
  h = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;
  var X = h[0],
    L = h[4],
    Y = h[5],
    Z = h[6],
    ...
    f = {
      ...
      findAllInRenderedTree: function(a, b) {
        ...
        return a ? V(a._reactInternalFiber, b) : [];
      },
  ...
  (function() {
    f.Simulate = {};
    for (var a in L) f.Simulate[a] = W(a);
  })();
  [
    ["abort", "abort"],
    [C, "animationEnd"],
