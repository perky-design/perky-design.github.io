...
(0, _helpers.test)("id and class names mixed", "#one.two.three", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "one");
...
(0, _helpers.test)("qualified id & class name", "h1#one.two", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].type, "tag");
...
(0, _helpers.test)("Sass interpolation within a class", ".#{foo}", function(
  t,
  tree
) {
...
(0, _helpers.test)("Sass interpolation within an id", "#foo#{bar}", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes.length, 1);
...
(0, _helpers.test)("Less interpolation within an id", "#foo@{bar}", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes.length, 1);
...
(0, _helpers.test)("id selector with escaping (2)", "#-a-b-c-", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (3)", "#u-m\\00002b", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (9)", "#𝄞♪♩♫♬", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "𝄞♪♩♫♬");
...
(0, _helpers.test)("id selector with escaping (14)", "#\\3A \\)", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, ":)");
...
(0, _helpers.test)("id selector with escaping (15)", "#\\3A \\`\\(", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, ":`(");
...
(0, _helpers.test)("id selector with escaping (16)", "#\\31 23", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (17)", "#\\31 a2b3c", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (18)", "#\\<p\\>", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (22)", "#\\#\\#", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "##");
...
(0, _helpers.test)("id selector with escaping (25)", "#\\{\\}", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "{}");
...
(0, _helpers.test)("id selector with escaping (27)", "#foo\\.bar", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "foo.bar");
...
(0, _helpers.test)("id selector with escaping (28)", "#\\3A hover", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (31)", "#f\\/o\\/o", function(
  t,
  tree
) {
...
(0, _helpers.test)("id selector with escaping (32)", "#f\\\\o\\\\o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f\\o\\o");
...
(0, _helpers.test)("id selector with escaping (33)", "#f\\*o\\*o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f*o*o");
...
(0, _helpers.test)("id selector with escaping (34)", "#f\\!o\\!o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f!o!o");
...
(0, _helpers.test)("id selector with escaping (35)", "#f\\'o\\'o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f'o'o");
...
(0, _helpers.test)("id selector with escaping (36)", "#f\\~o\\~o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f~o~o");
...
(0, _helpers.test)("id selector with escaping (37)", "#f\\+o\\+o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f+o+o");
