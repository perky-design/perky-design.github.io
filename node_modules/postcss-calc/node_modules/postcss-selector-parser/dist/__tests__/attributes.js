...
(0, _helpers.test)("attribute selector spaces (before)", "[  href]", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)("attribute selector spaces (after)", "[href  ]", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)(
  "attribute selector spaces with namespace (both)",
  "[  foo|bar   ]",
  function(t, tree) {
...
(0, _helpers.test)("attribute selector spaces (both)", "[  href   ]", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)(
  "select elements with or without a namespace",
  "[*|href]",
  function(t, tree) {
...
(0, _helpers.test)("namespace with escapes", "[\\31 \\#\\32 |href]", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "attribute selector with a empty value",
  '[href=""]',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)("attribute selector with a value", "[name=james]", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "attribute selector with quoted value",
  '[name="james"]',
  function(t, tree) {
    var attr = tree.nodes[0].nodes[0];
...
(0, _helpers.test)(
  "attribute selector with escaped quote",
...
(0, _helpers.test)(
  "attribute selector with escaped colon",
  "[ng\\:cloak]",
  function(t, tree) {
...
(0, _helpers.test)(
  "attribute selector with short hex escape",
  "[ng\\3a cloak]",
  function(t, tree) {
...
(0, _helpers.test)(
  "attribute selector with hex escape",
  "[ng\\00003acloak]",
  function(t, tree) {
...
(0, _helpers.test)(
  "assign attribute name requiring escape",
  "[ng\\:cloak]",
  function(t, tree) {
    var attr = tree.nodes[0].nodes[0];
...
(0, _helpers.test)(
  "multiple attribute selectors + combinator",
...
(0, _helpers.test)("attribute, class, combinator", "[href] > h2.test", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)(
  "attribute selector with quoted value & combinator",
  '[name="james"] > h1',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "james");
...
(0, _helpers.test)(
  "multiple quoted attribute selectors",
  ...
  function(t, tree) {
    ...
    t.is(
      tree.nodes[0].nodes[2].quoteMark,
      undefined,
      "should not have a quoteMark set"
    );
    ...
    t.is(
      tree.nodes[0].nodes[5].quoteMark,
      undefined,
      "should not have a quoteMark set"
    );
  }
...
(0, _helpers.test)(
  "more attribute operators",
  "[href*=test],[href^=test],[href$=test],[href|=test]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].operator, "*=");
...
(0, _helpers.test)(
  'attribute selector with quoted value containing "="',
...
var selector =
  ...
  '[data-weird-attr|="Something=weird"]';
(0, _helpers.test)(
  'more attribute selector with quoted value containing "="',
  selector,
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-attr");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "*=");
...
(0, _helpers.test)(
  'attribute selector with quoted value containing multiple "="',
  '[data-weird-attr="Something=weird SomethingElse=weirder"]',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-attr");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
    t.deepEqual(
      tree.nodes[0].nodes[0].value,
      "Something=weird SomethingElse=weirder"
    );
  }
);
selector =
  ...
  '[data-weird-attr|="Something=weird SomethingElse=weirder"]';
(0, _helpers.test)(
  'more attribute selector with quoted value containing multiple "="',
  selector,
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-attr");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "*=");
    ...
    t.deepEqual(tree.nodes[1].nodes[0].operator, "^=");
    t.deepEqual(
      tree.nodes[1].nodes[0].value,
      "Something=weird SomethingElse=weirder"
    );
    t.deepEqual(tree.nodes[2].nodes[0].attribute, "data-weird-attr");
    t.deepEqual(tree.nodes[2].nodes[0].operator, "$=");
    t.deepEqual(
      tree.nodes[2].nodes[0].value,
      "Something=weird SomethingElse=weirder"
    );
    t.deepEqual(tree.nodes[3].nodes[0].attribute, "data-weird-attr");
    t.deepEqual(tree.nodes[3].nodes[0].operator, "|=");
    t.deepEqual(
      tree.nodes[3].nodes[0].value,
      "Something=weird SomethingElse=weirder"
    );
  }
);
(0, _helpers.test)(
  'multiple attribute selectors with quoted value containing "="',
  '[data-weird-foo="foo=weird"][data-weird-bar="bar=weird"]',
  function(t, tree) {
...
(0, _helpers.test)(
  'multiple attribute selectors with value containing escaped "="',
  "[data-weird-foo=foo\\=weird][data-weird-bar=bar\\3d weird]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-foo");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
    t.deepEqual(tree.nodes[0].nodes[0].value, "foo=weird");
...
selector =
  ...
  '[data-weird-foo|="foo2=weirder"][data-weird-bar|="bar2=weirder"]';
(0, _helpers.test)(
  'more multiple attribute selectors with quoted value containing "="',
  selector,
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-foo");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "*=");
...
(0, _helpers.test)(
  'multiple attribute selectors with quoted value containing multiple "="',
...
selector =
  ...
  '[data-weird-foo|="foo1=weirder foo2=weirder"][data-weird-bar|="bar1=weirder bar2=weirder"]';
(0, _helpers.test)(
  'more multiple attribute selectors with quoted value containing multiple "="',
  selector,
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "data-weird-foo");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "*=");
...
(0, _helpers.test)(
  "insensitive attribute selector 1",
  '[href="test" i]',
  function(t, tree) {
...
(0, _helpers.test)(
  "insensitive attribute selector with a empty value",
  '[href="" i]',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
...
(0, _helpers.test)(
  "insensitive attribute selector 2",
  "[href=TEsT i  ]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "TEsT");
    t.deepEqual(tree.nodes[0].nodes[0].insensitive, true);
...
(0, _helpers.test)(
  "insensitive attribute selector 3",
  "[href=test i]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "test");
    t.deepEqual(tree.nodes[0].nodes[0].insensitive, true);
...
(0, _helpers.test)(
  "capitalized insensitive attribute selector 3",
  "[href=test I]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "test");
    t.deepEqual(tree.nodes[0].nodes[0].insensitive, true);
...
(0, _helpers.test)(
  "extraneous non-combinating whitespace",
  "  [href]   ,  [class]   ",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)(
  "comments within attribute selectors",
  "[href/* wow */=/* wow */test]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
...
(0, _helpers.test)(
  "comments within attribute selectors (2)",
  "[/* wow */href=test/* wow */]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
    t.deepEqual(tree.nodes[0].nodes[0].value, "test");
    t.deepEqual(
      tree.nodes[0].nodes[0].raws.spaces.attribute.before,
      "/* wow */"
    );
    t.deepEqual(tree.nodes[0].nodes[0].operator, "=");
...
(0, _helpers.test)(
  "comments within attribute selectors (3)",
  "[href=test/* wow */i]",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].attribute, "href");
...
(0, _helpers.test)(
  "comments within attribute selectors (4)",
...
(0, _helpers.test)("non standard modifiers", '[href="foo" y]', function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "comment after insensitive(non space)",
  '[href="foo" i/**/]',
  function(t, tree) {
...
(0, _helpers.test)(
  "comment after insensitive(space after)",
  '[href="foo" i/**/ ]',
  function(t, tree) {
    var attr = tree.atPosition(1, 13);
    t.deepEqual(attr.insensitive, true);
...
(0, _helpers.test)(
  "comment after insensitive(space before)",
  '[href="foo" i /**/]',
  function(t, tree) {
    var attr = tree.atPosition(1, 13);
    t.deepEqual(attr.insensitive, true);
...
var testDeprecation =
  (0, _helpers.nodeVersionAtLeast)("7.0.0") ||
  (0, _helpers.nodeVersionBefore)("6.0.0")
    ? _helpers.test
    : _helpers.test.skip;
