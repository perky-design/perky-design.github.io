...
(0, _helpers.test)("comments (2)", ".a  /*test comment*/label", function(
  t,
  tree
) {
...
(0, _helpers.test)("comments (3)", ".a  /*test comment*/  label", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].type, "class");
...
(0, _helpers.test)(
  "multiple comments and other things",
  "h1/*test*/h2/*test*/.test/*test*/",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].type, "tag", "should have a tag");
    t.deepEqual(
      tree.nodes[0].nodes[1].type,
      "comment",
      "should have a comment"
    );
    t.deepEqual(tree.nodes[0].nodes[2].type, "tag", "should have a tag");
    t.deepEqual(
      tree.nodes[0].nodes[3].type,
      "comment",
      "should have a comment"
    );
    t.deepEqual(
      tree.nodes[0].nodes[4].type,
      "class",
      "should have a class name"
    );
    t.deepEqual(
      tree.nodes[0].nodes[5].type,
      "comment",
      "should have a comment"
    );
  }
);
(0, _helpers.test)("ending in comment", ".bar /* comment 3 */", function(
  t,
  tree
) {
