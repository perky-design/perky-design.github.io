...
(0, _helpers.test)("pseudo element (single colon)", "h1:after", function(
  t,
  tree
) {
...
(0, _helpers.test)("pseudo element (double colon)", "h1::after", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].type, "tag");
...
(0, _helpers.test)("negation pseudo element", "h1:not(.heading)", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "negation pseudo element (2)",
  "h1:not(.heading, .title, .content)",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].value, ":not");
    t.deepEqual(tree.nodes[0].nodes[1].nodes[0].nodes[0].value, "heading");
...
(0, _helpers.test)(
  "negation pseudo element (4)",
  "h1:not(h2:not(h3))",
  function(t, tree) {
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[1].nodes[0].nodes[0].value,
      "h3"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[1].nodes[0].nodes[0].parent.type,
      "selector"
    );
  }
);
(0, _helpers.test)(
  "pseudo class in the middle of a selector",
  "a:link.external",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].type, "tag");
...
(0, _helpers.test)(
  "escaped numbers in class name with pseudo",
  "a:before.\\31\\ 0",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[2].type, "class");
...
(0, _helpers.test)(
  "negation pseudo element with quotes",
  'h1:not(".heading")',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].value, ":not");
    t.deepEqual(tree.nodes[0].nodes[1].nodes[0].nodes[0].value, '".heading"');
...
(0, _helpers.test)(
  "negation pseudo element with single quotes",
  "h1:not('.heading')",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].value, ":not");
    t.deepEqual(tree.nodes[0].nodes[1].nodes[0].nodes[0].value, "'.heading'");
...
(0, _helpers.test)(
  "non standard pseudo (@custom-selector)",
  ":--foobar, a",
  function(t, tree) {
...
(0, _helpers.test)(
  "non standard pseudo (@custom-selector) (1)",
  "a, :--foobar",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "a");
    t.deepEqual(tree.nodes[0].nodes[0].type, "tag");
