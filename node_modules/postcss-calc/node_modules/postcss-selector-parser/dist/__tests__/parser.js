...
(0, _ava.default)(
  "parse errors within the async processor before the promise returns",
  function(t) {
    return (0, _index.default)(function(selectors) {
...
(0, _ava.default)("returning a promise to the sync processor fails", function(
  t
) {
  t.throws(function() {
...
(0, _ava.default)("Passing a rule with mutation disabled works async", function(
  t
) {
  var rule = {
    selector: ".foo"
