...
(0, _helpers.test)("escaped numbers in class name", ".\\31\\ 0", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].type, "class");
...
(0, _helpers.test)("Less interpolation within a class", ".foo@{bar}", function(
  t,
  tree
) {
...
(0, _helpers.test)("escaped dot in class name", ".foo\\.bar", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].type, "class");
...
(0, _helpers.test)("class selector with escaping (2)", ".“‘’”", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "“‘’”");
...
(0, _helpers.test)("class selector with escaping (3)", ".☺☃", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "☺☃");
...
(0, _helpers.test)("class selector with escaping (4)", ".⌘⌥", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "⌘⌥");
...
(0, _helpers.test)("class selector with escaping (5)", ".𝄞♪♩♫♬", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "𝄞♪♩♫♬");
...
(0, _helpers.test)("class selector with escaping (6)", ".💩", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "💩");
...
(0, _helpers.test)("class selector with escaping (7)", ".\\?", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "?");
...
(0, _helpers.test)("class selector with escaping (8)", ".\\@", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "@");
...
(0, _helpers.test)("class selector with escaping (9)", ".\\.", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, ".");
...
(0, _helpers.test)("class selector with escaping (10)", ".\\3A \\)", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, ":)");
...
(0, _helpers.test)(
  "class selector with escaping (11)",
  ".\\3A \\`\\(",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, ":`(");
    t.deepEqual(tree.nodes[0].nodes[0].type, "class");
...
(0, _helpers.test)("class selector with escaping (12)", ".\\31 23", function(
  t,
  tree
) {
...
(0, _helpers.test)("class selector with escaping (13)", ".\\31 a2b3c", function(
  t,
  tree
) {
...
(0, _helpers.test)("class selector with escaping (14)", ".\\<p\\>", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  ...
  function(t, tree) {
    ...
    t.deepEqual(tree.nodes[0].nodes[0].type, "class");
    t.deepEqual(
      tree.nodes[0].nodes[0].raws.value,
      "\\<\\>\\<\\<\\<\\>\\>\\<\\>"
    );
  }
);
...
(0, _helpers.test)("class selector with escaping (17)", ".\\#", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "#");
...
(0, _helpers.test)("class selector with escaping (18)", ".\\#\\#", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "##");
...
(0, _helpers.test)("class selector with escaping (20)", ".\\_", function(
  t,
  tree
) {
...
(0, _helpers.test)("class selector with escaping (21)", ".\\{\\}", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "{}");
...
(0, _helpers.test)(
  "class selector with escaping (22)",
  ".\\#fake\\-id",
  function(t, tree) {
...
(0, _helpers.test)("class selector with escaping (23)", ".foo\\.bar", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "foo.bar");
...
(0, _helpers.test)("class selector with escaping (24)", ".\\3A hover", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "class selector with escaping (25)",
...
(0, _helpers.test)(
  "class selector with escaping (26)",
  ".\\[attr\\=value\\]",
  function(t, tree) {
...
(0, _helpers.test)("class selector with escaping (27)", ".f\\/o\\/o", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "class selector with escaping (28)",
  ".f\\\\o\\\\o",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].value, "f\\o\\o");
    t.deepEqual(tree.nodes[0].nodes[0].type, "class");
...
(0, _helpers.test)("class selector with escaping (29)", ".f\\*o\\*o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f*o*o");
...
(0, _helpers.test)("class selector with escaping (30)", ".f\\!o\\!o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f!o!o");
...
(0, _helpers.test)("class selector with escaping (31)", ".f\\'o\\'o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f'o'o");
...
(0, _helpers.test)("class selector with escaping (32)", ".f\\~o\\~o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f~o~o");
...
(0, _helpers.test)("class selector with escaping (33)", ".f\\+o\\+o", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "f+o+o");
...
(0, _helpers.test)("class selector with escaping (34)", ".\\1D306", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "𝌆");
