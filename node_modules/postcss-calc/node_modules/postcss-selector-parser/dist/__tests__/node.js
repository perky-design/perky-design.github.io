...
(0, _ava.default)("Node#setPropertyAndEscape without existing raws", function(
  t
) {
...
(0, _ava.default)("Node#setPropertyWithoutEscape with existing raws", function(
  t
) {
  var out = (0, _helpers.parse)(".fo\\o", function(selectors) {
    var className = selectors.first.first;
...
(0, _ava.default)(
  "Node#setPropertyWithoutEscape without existing raws",
  function(t) {
    var out = (0, _helpers.parse)(".foo", function(selectors) {
      var className = selectors.first.first;
      t.deepEqual(className.raws, undefined);
