...
(0, _helpers.test)("multiple combinating spaces", "h1         h2", function(
  t,
  tree
) {
...
(0, _helpers.test)("column combinator (2)", ".selected || td", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "selected");
...
(0, _helpers.test)("multiple descendant combinators", "h1 h2 h3 h4", function(
  t,
  tree
) {
...
(0, _helpers.test)("adjacent sibling combinator (2)", "h1 ~h2", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "h1");
...
(0, _helpers.test)("adjacent sibling combinator (3)", "h1~ h2", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "h1");
...
(0, _helpers.test)("adjacent sibling combinator (4)", "h1 ~ h2", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "h1");
...
(0, _helpers.test)("adjacent sibling combinator (5)", "h1~h2~h3", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].value, "h1");
...
(0, _helpers.test)("named combinators with escapes", "a /dee\\p/ b", function(
  t,
  tree
) {
  var nodes = tree.nodes[0].nodes;
...
(0, _helpers.test)(
  "named combinators with escapes and uppercase",
  "a /DeE\\p/ b",
  function(t, tree) {
    var nodes = tree.nodes[0].nodes;
    t.deepEqual(nodes[0].value, "a");
...
(0, _helpers.test)(
  "multiple combinators with whitespaces",
  "h1 + h2 > h3",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].value, "+", "should have a combinator");
    t.deepEqual(tree.nodes[0].nodes[3].value, ">", "should have a combinator");
...
(0, _helpers.test)(
  "multiple combinators with whitespaces (2)",
  "h1+ h2 >h3",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].value, "+", "should have a combinator");
    t.deepEqual(tree.nodes[0].nodes[3].value, ">", "should have a combinator");
...
(0, _helpers.test)("trailing combinator & spaces", "p +        ", function(
  t,
  tree
) {
...
(0, _helpers.test)(
  "ending in comment has no trailing combinator",
  ".bar /* comment 3 */",
  function(t, tree) {
...
(0, _helpers.test)(
  "The combinating space is not a space character",
  ".bar\n.baz",
  function(t, tree) {
    var nodeTypes = tree.nodes[0].map(function(n) {
      return n.type;
    ...
    t.deepEqual(tree.nodes[0].nodes[1].value, " ", "should have a combinator");
    t.deepEqual(
      tree.nodes[0].nodes[1].raws.value,
      "\n",
...
(0, _helpers.test)(
  "with spaces and a comment has only one combinator",
  ".bar /* comment 3 */ > .foo",
  function(t, tree) {
    var nodeTypes = tree.nodes[0].map(function(n) {
      return n.type;
...
(0, _helpers.test)(
  "with a meaningful comment in the middle of a compound selector",
  "div/* wtf */.foo",
  function(t, tree) {
    var nodeTypes = tree.nodes[0].map(function(n) {
      return n.type;
...
(0, _helpers.test)(
  "with a comment in the middle of a descendant selector",
  "div/* wtf */ .foo",
  function(t, tree) {
    var nodeTypes = tree.nodes[0].map(function(n) {
      return n.type;
