...
(0, _ava.default)("container#walk (safe iteration)", function(t) {
  var out = (0, _helpers.parse)("[class] + *[href] *:not(*.green)", function(
    selectors
  ) {
...
(0, _ava.default)("container#walkClass", function(t) {
  var out = (0, _helpers.parse)(
    ".one, .two, .three:not(.four, .five)",
    function(selectors) {
...
(0, _ava.default)("container#removeChild", function(t) {
  var out = (0, _helpers.parse)("h1.class h2.class h3.class", function(
    selectors
  ) {
    selectors.walk(function(selector) {
...
(0, _ava.default)(
  "Container#atPosition combinator in second selector",
  function(t) {
    (0, _helpers.parse)(":not(.foo),\n#foo > :matches(ol, ul)", function(root) {
...
(0, _ava.default)(
  "Container#atPosition tag in second selector pseudo",
  function(t) {
    (0, _helpers.parse)(":not(.foo),\n#foo > :matches(ol, ul)", function(root) {
...
(0, _ava.default)(
  "Container#atPosition comma in second selector pseudo",
  function(t) {
    (0, _helpers.parse)(":not(.foo),\n#foo > :matches(ol, ul)", function(root) {
