...
(0, _helpers.test)("comment & universal selectors", "*/*test*/*", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].source.start.column, 1);
...
(0, _helpers.test)("tag selector followed by id selector", "h1, #id", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[0].source.start.column, 1);
...
(0, _helpers.test)("multiple id selectors (2)", "#one#two#three#four", function(
  t,
  tree
) {
...
(0, _helpers.test)("multiple class selectors", ".one.two,.three.four", function(
  t,
  tree
) {
  t.deepEqual(tree.nodes[0].nodes[1].source.start.column, 5);
...
(0, _helpers.test)(
  ...
  '[name="james"][name="ed"],[name="snakeman"][name="a"]',
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].source.start.line, 1);
    t.deepEqual(tree.nodes[0].nodes[0].source.start.column, 1);
...
(0, _helpers.test)(
  "multiple pseudos",
  "h1:not(.food)::before, a:first-child",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].source.start.line, 1);
    t.deepEqual(tree.nodes[0].nodes[1].source.start.column, 3);
...
(0, _helpers.test)("combinators", "div > h1 span", function(t, tree) {
  ...
  t.deepEqual(
    tree.nodes[0].nodes[3].source.start.column,
    9,
    "' ' start column"
  );
...
(0, _helpers.test)(
  "combinators surrounded by superfluous spaces",
  "div   >  h1 ~   span   a",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[1].source.start.line, 1, "> start line");
    t.deepEqual(
      tree.nodes[0].nodes[1].source.start.column,
      7,
      "> start column"
    );
    ...
    t.deepEqual(
      tree.nodes[0].nodes[5].source.start.column,
      21,
      "' ' start column"
    );
...
(0, _helpers.test)(
  "multiple id selectors on different lines",
  "#one,\n#two",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].source.start.line, 1);
    t.deepEqual(tree.nodes[0].nodes[0].source.start.column, 1);
...
(0, _helpers.test)(
  "multiple id selectors on different CRLF lines",
  "#one,\r\n#two,\r\n#three",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].source.start.line, 1, "#one start line");
    t.deepEqual(
      tree.nodes[0].nodes[0].source.start.column,
      1,
      "#one start column"
    );
    ...
    t.deepEqual(
      tree.nodes[1].nodes[0].source.start.column,
      1,
      "#two start column"
    );
    ...
    t.deepEqual(
      tree.nodes[2].nodes[0].source.start.line,
      3,
      "#three start line"
    );
    t.deepEqual(
      tree.nodes[2].nodes[0].source.start.column,
      1,
      "#three start column"
    );
    t.deepEqual(
      tree.nodes[2].nodes[0].source.end.column,
      6,
      "#three end column"
    );
...
(0, _helpers.test)(
  "id, tag, pseudo, and class selectors on different lines with indentation",
  "\t#one,\n\th1:after,\n\t\t.two",
  function(t, tree) {
    t.deepEqual(tree.nodes[0].nodes[0].source.start.line, 1, "#one start line");
    t.deepEqual(
    ...
    t.deepEqual(
      tree.nodes[1].nodes[1].source.start.line,
      2,
      ":after start line"
    );
    t.deepEqual(
      tree.nodes[1].nodes[1].source.start.column,
      4,
      ":after start column"
    );
    t.deepEqual(
      tree.nodes[1].nodes[1].source.end.column,
      9,
      ":after end column"
    );
...
(0, _helpers.test)(
  "pseudo with arguments spanning multiple lines",
  "h1:not(\n\t.one,\n\t.two\n)",
  function(t, tree) {
    ...
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[0].source.start.line,
      2,
      ".one start line"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[0].source.start.column,
      2,
      ".one start column"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[0].source.end.line,
      2,
      ".one end line"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[0].source.end.column,
      5,
      ".one end column"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[0].nodes[0].sourceIndex,
      9,
      ".one sourceIndex"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[1].nodes[0].source.start.line,
      3,
      ".two start line"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[1].nodes[0].source.start.column,
      2,
      ".two start column"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[1].nodes[0].source.end.line,
      3,
      ".two end line"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[1].nodes[0].source.end.column,
      5,
      ".two end column"
    );
    t.deepEqual(
      tree.nodes[0].nodes[1].nodes[1].nodes[0].sourceIndex,
      16,
      ".two sourceIndex"
    );
  }
