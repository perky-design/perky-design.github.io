!(function(t, e) {
  ...
  var I = {
    ...
    block: function(t, e, r, a, n, i) {
      ...
      return (
        ...
        (s =
          null != n && "Template" === n.type ? b({}, n, { type: "Block" }) : n),
        {
          type: "BlockStatement",
          path: _(t),
          params: e || [],
    ...
    mustacheComment: function(t, e) {
      return { type: "MustacheCommentStatement", value: t, loc: O(e || null) };
    },
    ...
    path: _,
    concat: function(t, e) {
      return { type: "ConcatStatement", parts: t || [], loc: O(e || null) };
    },
    hash: N,
    pair: L,
    literal: T,
    ...
    var e = (function(t) {
      ...
      if (-1 !== n && e > n && "|" === r[n + 1].charAt(0)) {
        ...
        if ("|" !== i.charAt(i.length - 1) || 2 !== i.match(/\|/g).length)
          throw new R("Invalid block parameters syntax: '" + i + "'", t.loc);
        ...
        if (0 === o.length)
          throw new R("Cannot use zero block parameters: '" + i + "'", t.loc);
  ...
  var X = (function() {
    ...
    tt = (function(t) {
      function e() {
        ...
        return (
          a(this, e),
          ((t = c(this, s(e).apply(this, arguments))).cursorCount = 0),
          t
        );
      }
      return (
            ...
            value: function(t) {
              ...
              (this.cursorCount = 0),
                (e = this.isTopLevel
                  ...
                  : I.blockItself(r, t.blockParams, t.chained, t.loc));
              var a,
                n = t.body.length;
            ...
            value: function(t) {
              if ("comment" !== this.tokenizer.state) {
                ...
                var e = et(this, t),
                  ...
                  o = t.inverse ? this.Program(t.inverse) : null;
                "in-element" === r.original &&
                  (n = (function(t, e, r) {
                    var a = !1;
                    e.pairs.forEach(function(t) {
                      if ("guid" === t.key)
                        throw new R("Cannot pass `guid` from user space", r);
                      "insertBefore" === t.key && (a = !0);
                    });
                    var n = I.literal("StringLiteral", t),
                      i = I.pair("guid", n);
                    if ((e.pairs.unshift(i), !a)) {
                      var o = I.literal("UndefinedLiteral", void 0),
                ...
                switch (e.state) {
                  ...
                  case "afterAttributeName":
                    this.beginAttributeValue(!1),
                      ...
                      rt(this.currentStartTag, r),
                      e.transitionTo("beforeAttributeName");
                    break;
                  ...
                  case "beforeAttributeValue":
                    this.beginAttributeValue(!1),
                      ...
                      e.transitionTo("attributeValueUnquoted");
                    break;
          ...
          },
          {
            ...
            value: function(t) {
              for (var e = [], r = 0; r < t.pairs.length; r++) {
                var a = t.pairs[r];
                e.push(I.pair(a.key, this.acceptNode(a.value), a.loc));
              }
  ...
  function ht(t, e) {
    var r,
      ...
      n,
      i = (function(t, e) {
        if (("Template" === e || "Block" === e) && t.Program) return t.Program;
        var r = t[e];
      ...
      if (Array.isArray(n)) dt(t, n);
        ...
        void 0 !== l &&
          (function(t, e, r, a) {
            ...
            if (Array.isArray(a)) {
              if (1 !== a.length)
                throw 0 === a.length ? ot(r, t, e) : st(r, t, e);
              pt(t, e, a[0]);
            } else pt(t, e, a);
          })(r, a, n, l);
      }
    ...
    switch (t.type) {
        ...
        "TextNode" === t.value.type
          ? "" !== t.value.chars
            ? (l.push(t.name, "="),
              l.push(
                '"',
                "raw" === e.entityEncoding ? t.value.chars : xt(t.value.chars),
                '"'
              ))
            : l.push(t.name)
      ...
      case "ConcatStatement":
        l.push('"'),
          t.parts.forEach(function(t) {
            "TextNode" === t.type
              ? l.push("raw" === e.entityEncoding ? t.chars : xt(t.chars))
              : l.push(Et(t, e));
          }),
          l.push('"');
        break;
      ...
      case "BlockStatement":
        ...
        t.chained
          ...
          t.inverse &&
            (t.inverse.chained || h.push("{{else}}"), h.push(Et(t.inverse, e))),
          t.chained ||
            h.push(
              (function(t) {
        ...
        i(t, [
          ...
          },
          {
            ...
            value: function(t, e) {
              var r;
              r =
                "Block" === t.type || ("Template" === t.type && At.Program)
                  ? "Program"
                  : t.type;
              var a = At[r];
              a && a(this, t, e);
  ...
  var Lt = Nt(function(t, e) {
    ...
    var u =
      Array.isArray ||
      function(t) {
        return !(!t || "object" !== r(t)) && "[object Array]" === l.call(t);
      };
    e.isArray = u;
  });
  Tt(Lt);
      ...
      (e.default = function(t) {
        t.registerHelper("blockHelperMissing", function(e, r) {
          ...
          if (r.data && r.ids) {
            ...
            (i.contextPath = Lt.appendContextPath(r.data.contextPath, r.name)),
              (r = { data: i });
          }
          return n(e, r);
        });
      ...
      t.registerHelper("each", function(t, e) {
        ...
        function u(e, r, n) {
          l &&
            ...
            (s += a(t[e], {
              data: l,
              blockParams: Lt.blockParams([t[e], e], [c + e, null])
            }));
        }
        if (
          (e.data &&
            e.ids &&
            (c = Lt.appendContextPath(e.data.contextPath, e.ids[0]) + "."),
          ...
          if (Lt.isArray(t))
            ...
            for (
              var p = [], f = t[_t.Symbol.iterator](), d = f.next();
              !d.done;
              d = f.next()
            )
              p.push(d.value);
            for (h = (t = p).length; o < h; o++) u(o, o, o === t.length - 1);
          } else {
            var m = void 0;
            for (var g in t)
              t.hasOwnProperty(g) &&
      ...
      (e.default = function(t) {
        t.registerHelper("with", function(t, e) {
          ...
          return (
            e.data &&
              e.ids &&
              ((a = Lt.createFrame(e.data)).contextPath = Lt.appendContextPath(
                e.data.contextPath,
                e.ids[0]
              )),
            r(t, {
              data: a,
              blockParams: Lt.blockParams([t], [a && a.contextPath])
            })
          );
        });
      }),
  ...
  var Ft = Nt(function(t, e) {
    (e.__esModule = !0),
      ...
      (e.template = function(t, e) {
        ...
        var s = {
          ...
          invokePartial: function(r, a, o) {
            o.hash && ((a = n.extend({}, a, o.hash)), o.ids && (o.ids[0] = !0)),
        ...
        function c(e) {
          ...
          function o(e) {
            return "" + t.main(s, e, s.helpers, s.partials, a, i, n);
          }
          return (
            t.useDepths &&
              (n = r.depths
          ...
          (c._setup = function(r) {
            if (r.partial)
              ...
              (s.helpers = n.extend({}, e.helpers, r.helpers)),
                t.usePartial &&
                  (s.partials = n.extend({}, e.partials, r.partials)),
                (t.usePartial || t.useDecorators) &&
                  (s.decorators = n.extend({}, e.decorators, r.decorators)),
                (s.hooks = {});
              var i = r.allowCallsToHelperMissing || a;
              Ht.moveHelperToHooks(s, "helperMissing", i),
                Ht.moveHelperToHooks(s, "blockHelperMissing", i);
            }
          }),
      ...
      (e.invokePartial = function(t, e, r) {
        ...
        void 0 === t && o && (t = o);
        if (void 0 === t)
          throw new i.default("The partial " + r.name + " could not be found");
          ...
          performAction: function(t, e, r, a, n, i, o) {
            ...
            switch (n) {
              ...
              case 10:
                ...
                break;
              case 11:
                this.$ = a.prepareRawBlock(i[s - 2], i[s - 1], i[s], this._$);
                break;
              case 12:
              ...
              case 19:
                ...
                (c.chained = !0),
                  (this.$ = { strip: i[s - 2].strip, program: c, chain: !0 });
                break;
              case 20:
                this.$ = i[s];
                break;
              ...
              case 29:
                ...
                break;
              case 30:
                this.$ = { type: "Hash", pairs: i[s], loc: a.locInfo(this._$) };
                break;
              case 31:
                this.$ = {
                  type: "HashPair",
        ...
        for (var a = t.body, n = 0, c = a.length; n < c; n++) {
          ...
          if (h) {
            ...
            h.close && s(a, n, !0),
              ...
              e && d && (s((u.program || u.inverse).body), l(a, n)),
              e && m && (s(a, n), l((u.inverse || u.program).body));
          }
        }
        return t;
      }),
  ...
  var Zt = Nt(function(t, e) {
    (e.__esModule = !0),
      ...
      (e.preparePath = function(t, e, r) {
        ...
        for (
          ...
          if (
            ...
            if (i.length > 0)
              throw new a.default("Invalid path: " + n, { loc: r });
            ".." === c && o++;
          }
        }
        return {
      ...
      (e.prepareBlock = function(t, e, r, i, o, s) {
        ...
        if (r) {
          if (l)
            throw new a.default("Unexpected inverse block on decorator", r);
  ...
  var te = Nt(function(t, e) {
    ...
    function s(t, e) {
      ...
      if (Lt.isArray(t) && Lt.isArray(e) && t.length === e.length) {
        for (var r = 0; r < t.length; r++) if (!s(t[r], e[r])) return !1;
        return !0;
      }
    }
    function l(t) {
      ...
      classifySexpr: function(t) {
        ...
        if (i && !a) {
          var o = t.path.parts[0],
            s = this.options;
          s.knownHelpers[o] ? (a = !0) : s.knownHelpersOnly && (i = !1);
        }
  ...
  var ee = Nt(function(t, e) {
    ...
    r ||
      ((r = function(t, e, r, a) {
        ...
        prepend: function(t) {
          Lt.isArray(t) && (t = t.join("")), (this.src = t + this.src);
        },
  ...
  var re = Nt(function(t, e) {
    ...
    (o.prototype = {
      nameLookup: function(t, e) {
        ...
        return "constructor" === e ? ["(", r, "?", a(), " : undefined)"] : a();
        function a() {
      ...
      compileChildren: function(t, e) {
        for (
          var r = t.children, a = void 0, n = void 0, i = 0, o = r.length;
          i < o;
          i++
        ) {
      ...
      replaceStack: function(t) {
        ...
        if (s instanceof i) (e = ["(", (r = [s.value])]), (o = !0);
          ...
          (e = ["((", this.push(l), " = ", s, ")"]), (r = this.topStack());
        }
        var c = t.call(this, r);
        o || this.popStack(),
          n && this.stackSlot--,
      ...
      setupParams: function(t, e, r) {
        ...
        var c = this.popStack(),
          u = this.popStack();
        (u || c) &&
          ((a.fn = u || "container.noop"), (a.inverse = c || "container.noop"));
        for (var h = e; h--; )
          (l = this.popStack()),
            (r[h] = l),
            this.trackIds && (o[h] = this.popStack()),
            this.stringParams &&
              ((i[h] = this.popStack()), (n[h] = this.popStack()));
        return (
      ...
      i(e, [
          ...
          value: function() {
            (this.currentNode = I.comment("")),
              (this.currentNode.loc = {
                source: null,
                start: I.pos(this.tagOpenLine, this.tagOpenColumn),
                end: null
              });
          }
        },
        ...
        },
        {
          ...
          value: function() {
            (this.currentNode = I.text()),
              (this.currentNode.loc = {
                source: null,
                start: I.pos(this.tokenizer.line, this.tokenizer.column),
                end: null
              });
          }
        },
        ...
        },
        {
          ...
          value: function() {
            var t = this.tokenizer,
              ...
              r = t.column,
              a = this.currentTag;
            (a.loc = I.loc(this.tagOpenLine, this.tagOpenColumn, e, r)),
              "StartTag" === a.type
                ? (this.finishStartTag(),
                  (ie[a.name] || a.selfClosing) && this.finishEndTag(!0))
          ...
          value: function(t) {
            ...
            !(function(t, e, r) {
              ...
              ie[t.name] && !r
                ...
                : void 0 === e.tag
                ? (a = "Closing tag " + se(t) + " without an open tag.")
                : e.tag !== t.name &&
                  (a =
                    "Closing tag " +
                    se(t) +
        ...
        },
        {
          ...
          value: function() {
            ...
            s.loc = I.loc(i, o, this.tokenizer.line, this.tokenizer.column);
            var l = I.loc(
  ...
  function ce(t) {
    ...
    if (a && a.plugins && a.plugins.ast)
      for (var l = 0, c = a.plugins.ast.length; l < c; l++) {
        gt(
          s,
          (0, a.plugins.ast[l])(b({}, a, { syntax: le }, { plugins: void 0 }))
            .visitor
        );
      }
    return s;
        ...
        glimmer: {
          parse: function(t) {
            try {
              ...
              throw r
                ? e(t.message, { start: { line: Number(r[1]), column: 0 } })
                : t;
            }
          },
          astFormat: "glimmer",
