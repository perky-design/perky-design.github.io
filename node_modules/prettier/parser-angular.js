!(function(e, t) {
   ...
   */ var y = function e(t, n, i, r) {
    ...
    C = (function(e) {
      function t(e, n) {
        var i;
        return (
          a(this, t), ((i = p(this, c(t).call(this, e))).expressions = n), i
        );
      }
      return (
        l(t, e),
    ...
    B = (function(e) {
      function t(e, n) {
        var i;
        return (
          a(this, t), ((i = p(this, c(t).call(this, e))).expression = n), i
        );
      }
      return (
        l(t, e),
        ...
        u(e, [
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              return n !== e.condition || i !== e.trueExp || r !== e.falseExp
                ? new P(e.span, n, i, r)
                : e;
            }
          },
        ...
        u(e, [
          {
            key: "tokenize",
            value: function(e) {
              for (var t = new _e(e), n = [], i = t.scanToken(); null != i; )
            ...
            value: function() {
              ...
              switch (n) {
                case 46:
                  return (
                    this.advance(),
                    be(this.peek) ? this.scanNumber(s) : Ne(s, 46)
                  );
                case 40:
                case 41:
                case 123:
          ...
          },
          {
            ...
            value: function(e, t, n, i, r, s) {
              ...
              return (
                ...
                null != r && this.peek == r && (this.advance(), (a += s)),
                Oe(e, a)
              );
            }
          },
          ...
          },
          {
            ...
            value: function() {
              var e = this.index,
                t = this.peek;
              this.advance();
              for (var n = "", i = this.index, r = this.input; this.peek != t; )
                if (92 == this.peek) {
                  ...
                  if (((this.peek = this.peek), 117 == this.peek)) {
                    ...
                    if (!/^[0-9a-f]+$/i.test(a))
                      return this.error(
                        "Invalid unicode escape [\\u".concat(a, "]"),
                        0
                      );
                    s = parseInt(a, 16);
  ...
  var ze = (function() {
        ...
        u(e, [
          ...
          },
          {
            ...
            value: function(e, t, n) {
              ...
              return new W(
                new M(new x(0, null == e ? 0 : e.length), r.strings, s),
                e,
                t,
                n,
                this.errors
              ...
              for (
                ...
                l % 2 == 0
                  ...
                  : (this._reportError(
                      ...
                      e,
                      "at column ".concat(
                        this._findInterpolationErrorColumn(r, l, n),
                        " in"
                      ),
                      t
                    ),
            ...
            value: function(e, t, n) {
              ...
              r.length > 1 &&
                this._reportError(
                  "Got interpolation ("
                    .concat(n.start)
                    .concat(n.end, ") where expression was expected"),
                  e,
                  "at column ".concat(
                    this._findInterpolationErrorColumn(r, 1, n),
                    " in"
                  ),
                  t
                );
          ...
          },
          {
            ...
            value: function() {
              ...
              if (this.optionalOperator("|")) {
                ...
                do {
                  for (
                    var t = this.expectIdentifierOrKeyword(), n = [];
          ...
          },
          {
            ...
            value: function() {
              ...
              if (this.optionalOperator("?")) {
                var n,
                  i = this.parsePipe();
                if (this.optionalCharacter(58)) n = this.parsePipe();
                else {
                ...
                switch (n) {
                  case "+":
                    return (
                      this.advance(),
                      (e = this.parsePrefix()),
                      new K(this.span(t), "-", e, new I(new x(t, t), 0))
                    );
                  case "-":
                    return (
                      this.advance(),
                      (e = this.parsePrefix()),
                      new K(this.span(t), n, new I(new x(t, t), 0), e)
                    );
                  case "!":
                    return (
                      this.advance(),
              ...
              for (var e = this.parsePrimary(); ; )
                if (this.optionalCharacter(46))
                  ...
                  this.rparensExpected--,
                    ...
                    (e = new F(this.span(e.span.start), e, i));
                } else {
          ...
          },
          {
            ...
            value: function() {
              ...
              if (this.next.isKeywordNull())
                return this.advance(), new I(this.span(e), null);
              if (this.next.isKeywordUndefined())
                return this.advance(), new I(this.span(e), void 0);
              ...
              return this.index >= this.tokens.length
                ? (this.error(
                    "Unexpected end of expression: ".concat(this.input)
                  ),
                  new m(this.span(e)))
                : (this.error("Unexpected token ".concat(this.next)),
                  new m(this.span(e)));
          ...
          },
          {
            ...
            value: function(e) {
              ...
              do {
                ...
                t
                  ? ((r = s = e), (t = !1))
                  : ((a = this.peekKeywordLet()) && this.advance(),
                    (r = this.expectTemplateBindingKey()),
                    (s = a ? r : e + r[0].toUpperCase() + r.substring(1)),
                    this.optionalCharacter(58));
                var o = null,
                  u = null;
                if (a)
                  ...
                  this.advance(),
                    ...
                    (a = !0);
                else if (this.next !== Ie && !this.peekKeywordLet()) {
            ...
            value: function(e) {
              var t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : null;
              this.errors.push(
                new y(e, this.input, this.locationText(t), this.location)
              ),
                this.skip();
            }
          },
    ...
    He = r(function(e, t) {
      ...
      function c(e, t) {
        for (var n = e.start, i = e.end; i !== t.length && /\s/.test(t[i]); )
          i++;
      ...
      (t.parseNgBinding = function(e) {
        ...
        (t.fitSpans = function(e, t, n) {
          ...
          return {
            hasParens: 0 !== (n ? i - 1 : i),
            outerSpan: l(n ? { start: r.start + 1, end: r.end - 1 } : r, t),
            innerSpan: l(e, t)
          };
        }),
  ...
  var Je = r(function(e, t) {
    function n(e, t, n, i) {
      ...
      return Object.assign(
        ...
        l && {
          extra: { parenthesized: !0, parenStart: o.start, parenEnd: o.end }
        }
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.transform = function(e, i) {
        ...
        switch (a) {
          case "Binary":
            ...
            if (c || h) {
              ...
              return Ae(
                "UnaryExpression",
                { prefix: !0, argument: p, operator: c ? "+" : "-" },
          ...
          case "BindingPipe":
            ...
            return Ae(
              ...
              { start: _e(g), end: Le(0 === w.length ? m : He.getLast(w)) },
              { hasParentParens: r }
            );
          case "Chain":
            var C = e.expressions;
          ...
          case "Comment":
            var P = e.value;
            return Ae("CommentLine", { value: P }, e.span, { processSpan: !1 });
          case "Conditional":
            var b = e.condition,
              A = e.trueExp,
              E = e.falseExp,
          ...
          case "EmptyExpr":
            return Ae("NGEmptyExpression", {}, e.span, { hasParentParens: r });
          case "FunctionCall":
            var I = e.target,
              _ = e.args,
          ...
          case "LiteralArray":
            var j = e.expressions;
            return Ae("ArrayExpression", { elements: j.map(Pe) }, e.span, {
              hasParentParens: r
            });
          case "LiteralMap":
            var F = e.keys,
              ...
              G = F.map(function(t, n) {
                var i = t.key,
                  ...
                  a = {
                    start: Ne(
                      /\S/,
                      0 === n ? e.span.start + 1 : Ne(/,/, Le(W[n - 1])) + 1
                    ),
                ...
                return Ae(
                  "ObjectProperty",
                  { key: o, value: s, method: !1, shorthand: !1, computed: !1 },
                  { start: _e(o), end: Le(s) }
                );
              });
            return Ae("ObjectExpression", { properties: G }, e.span, {
              hasParentParens: r
            });
          case "LiteralPrimitive":
            ...
            switch (s(U)) {
              case "boolean":
                return Ae("BooleanLiteral", { value: U }, e.span, {
                  hasParentParens: r
                });
              case "number":
                return Ae("NumericLiteral", { value: U }, e.span, {
                  hasParentParens: r
                });
              case "object":
                return Ae("NullLiteral", {}, e.span, { hasParentParens: r });
              case "string":
                return Ae("StringLiteral", { value: U }, e.span, {
                  hasParentParens: r
                });
              case "undefined":
                return Ae("Identifier", { name: "undefined" }, e.span, {
                  hasParentParens: r
                });
              default:
                throw new Error(
                  "Unexpected LiteralPrimitive value type ".concat(s(U))
                );
            }
          case "MethodCall":
          case "SafeMethodCall":
            var Q = "SafeMethodCall" === a,
              ...
              H =
                Se(
                  ...
                  Se(
                    /\(/,
                    (0 === D.length ? Se(/\)/, e.span.end - 1) : _e(D[0])) - 1
                  ) - 1
                ) + 1,
              J = Ae(
                "Identifier",
              ...
              Y = Oe(X);
            return Ae(
              Q || Y ? "OptionalCallExpression" : "CallExpression",
          ...
          case "SafePropertyRead":
            var ie = "SafePropertyRead" === a,
              ...
              oe = Ae(
                ...
                re.span.start === re.span.end ? { hasParentParens: r } : {}
              );
            return Ee(
              re,
              oe,
          ...
          case "Quote":
            ...
            return Ae("NGQuotedExpression", { prefix: we, value: Ce }, e.span, {
              hasParentParens: r
            });
          default:
        ...
        function Ee(e, t, n) {
          ...
          var u =
            ...
            l = Oe(u);
          return Ae(
            n.optional || l ? "OptionalMemberExpression" : "MemberExpression",
            Object.assign(
              { object: u, property: t, computed: n.computed },
              n.optional ? { optional: !0 } : l ? { optional: !1 } : null
            ),
            { start: _e(u), end: s },
            { hasParentParens: o }
          );
      ...
      (t.transformTemplateBindings = function(e, t) {
        for (
          var n = v(e, 1)[0],
            i = n.key,
            r =
              0 === t.text.slice(n.span.start, n.span.end).trim().length
                ? e.slice(1)
                : e,
            s = [],
            a = null,
                ...
                var e = x(He.findBackChar(/\S/, p.start + 3, t.text), l),
                  ...
                  i = function(e, n) {
                    return Object.assign(
                      {},
                      e,
                      Je.transformSpan({ start: e.start, end: n }, t)
                    );
                  },
                  r = function(e) {
                    return Object.assign({}, i(e, n.end), { alias: n });
                  },
                  a = s.pop();
                if ("NGMicrosyntaxExpression" === a.type) s.push(r(a));
                else {
                  if ("NGMicrosyntaxKeyedExpression" !== a.type)
                    throw new Error("Unexpected type ".concat(a.type));
                  var o = r(a.expression);
                  s.push(i(Object.assign({}, a, { expression: o }), o.end));
                }
              })()
            : s.push(f(u, o)),
            (a = u);
        ...
        function f(e, n) {
            ...
            if (/^let\s$/.test(t.text.slice(o.start, o.start + 4))) {
              ...
              return y(
                "NGMicrosyntaxLet",
                {
                  ...
                  value:
                    0 === t.text.slice(u.end, o.end).trim().length
                      ? null
                      : y(
                          "NGMicrosyntaxKey",
                          { name: s },
          ...
          if (a) {
            ...
            return y(
              ...
              {
                key: y("NGMicrosyntaxKey", { name: v }, x(o.start, v)),
                expression: y(
                  "NGMicrosyntaxExpression",
        ...
        function y(e, n, i) {
          ...
          return Object.assign({ type: e }, Je.transformSpan(i, t, r, !1), n);
        }
        function x(e, n) {
          ...
          for (var i = t.text[e], r = 0, s = e + 1; ; ) {
            var a = t.text[s];
            if (a === i && r % 2 == 0) return { start: e, end: s + 1 };
            "\\" === a ? r++ : (r = 0), s++;
          }
        }
        function g(e) {
    ...
    return Object.assign(
      {
        ...
        parse: function(t, n, i) {
          ...
          return {
            type: "NGRoot",
            node:
              "__ng_action" === i.parser && "NGChainedExpression" !== r.type
                ? Object.assign({}, r, {
