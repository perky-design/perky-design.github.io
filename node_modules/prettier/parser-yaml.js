!(function(e, t) {
  ...
  ***************************************************************************** */ var E = function(
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.getPrettyContext = function(e, t) {
        var n = e.start,
          r = e.end,
          o =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 80,
          i = a(n.line, t);
        if (!i) return null;
        var s = n.col;
        if (i.length > o)
            ...
            get: function() {
              if (this.context)
                for (
                  ...
                  if (e[this.props[t].start] === T.Char.COMMENT) return !0;
              return !1;
            }
          },
          {
  ...
  var I = o(function(e, t) {
    ...
    var i = (function(e) {
      function t(e, n) {
        var r;
        return (
          s(this, t), ((r = g(this, c(t).call(this, e, n))).node = null), r
        );
      }
      return (
        l(t, e),
        f(t, [
            ...
            value: function(e, t) {
              ...
              for (
                ...
                if ("#" === c) {
                  ...
                  (s = !0),
                    (u = l + 1),
                    "\n" === i[r.default.endOfWhiteSpace(i, u)] &&
                      0 === h.length &&
                      (u = (p = new n.default()).parse({ src: i }, u)),
          ...
          },
          {
            ...
            value: function(e, n) {
              return (
                (n = m(c(t.prototype), "setOrigRanges", this).call(this, e, n)),
  ...
  var D = o(function(e, t) {
    ...
    function d(e) {
      ...
      for (
        ...
        (t.range.end = c),
          t.valueRange && t.valueRange.end > c && (t.valueRange.end = c),
          t !== e;
        ...
        f(t, [
          {
            ...
            value: function(e, r) {
              ...
              (l.context.parent = this),
                (this.valueRange = i.default.copy(l.valueRange));
              for (
                var c = l.range.start - l.context.lineStart,
                  h = r,
                  p = u[(h = o.default.normalizeOffset(u, h))],
                ...
                for (; "\n" === p || "#" === p; ) {
                  if (v && "\n" === p && !g) {
                    ...
                    var y = new a.default();
                    if (
                      ((h = y.parse({ indent: c, lineStart: f, src: u }, h)),
                      this.items.push(y),
                      (this.valueRange.end = h),
                      h >= u.length)
                    ) {
                ...
                if (
                  ...
                  (p = u[(h = o.default.normalizeOffset(u, O.range.end))]),
                  (v = !1),
                  (g = O.includesTrailingLines),
                  p)
                ) {
                  for (var M = h - 1, S = u[M]; " " === S || "\t" === S; )
                    S = u[--M];
                  "\n" === S && ((f = M + 1), (v = !0));
                }
                var A = d(O);
  ...
  var j = o(function(e, t) {
    ...
    var o = (function(e) {
      function t() {
        ...
        return (
          s(this, t),
          ((e = g(this, c(t).call(this, T.Type.DIRECTIVE))).name = null),
          e
        );
      }
      return (
  ...
  var Y = o(function(e, t) {
    ...
    var d = (function(e) {
      function t() {
        ...
        return (
          s(this, t),
          ((e = g(this, c(t).call(this, T.Type.DOCUMENT))).directives = null),
          (e.contents = null),
        ...
        f(t, [
          {
            ...
            value: function(e) {
              ...
              for (
                var u = !0, f = !1, l = e;
                !o.default.atDocumentBoundary(s, l, T.Char.DIRECTIVES_END);

              )
                switch (s[(l = t.startCommentOrEndBlankLine(s, l))]) {
                  case "\n":
                    if (u) {
                      var c = new n.default();
                      (l = c.parse({ src: s }, l)) < s.length &&
              ...
              return s[l]
                ? ((this.directivesEndMarker = new i.default(l, l + 3)), l + 3)
                : (f
                    ? (this.error = new x.YAMLSemanticError(
                        this,
                        "Missing directives-end indicator line"
          ...
          },
          {
            ...
            value: function(e) {
              ...
              for (
                ...
                !o.default.atDocumentBoundary(u, l, T.Char.DOCUMENT_END);
              ...
              if (
                ...
                u[l] &&
                  ((this.documentEndMarker = new i.default(l, l + 3)),
                  u[(l += 3)]))
              ) {
                if ("#" === u[(l = o.default.endOfWhiteSpace(u, l))]) {
                  var m = new r.default();
                  (l = m.parse({ src: u }, l)), this.contents.push(m);
                }
                switch (u[l]) {
                  case "\n":
                    l += 1;
          ...
          },
          {
            ...
            value: function() {
              ...
              return (
                e.length > 0 &&
                  ((t.length > 0 || e[0].type === T.Type.COMMENT) &&
                    (r += "---\n"),
                  (r += e.join(""))),
                "\n" !== r[r.length - 1] && (r += "\n"),
                r
            ...
            value: function(e) {
              for (var t = this.context.src, n = e + 1, a = ""; ; ) {
                ...
                switch (i) {
                  ...
                  default:
                    return (
                      (this.blockIndent = Number(a) || null),
            ...
            value: function(e) {
              for (
                var t = this.context,
                  ...
                  s = e,
                  u = e,
                  f = this.blockIndent ? a + this.blockIndent - 1 : a,
                  l = 1,
                  c = i[s];
                "\n" === c && ((s += 1), !n.default.atDocumentBoundary(i, s));
                c = i[s]
              ) {
              ...
              return (
                this.chomping !== o.KEEP && (s = i[u] ? u + 1 : u),
  ...
  var K = o(function(e, t) {
    ...
    var u = (function(e) {
      function t(e, n) {
        var r;
        return (
          s(this, t), ((r = g(this, c(t).call(this, e, n))).items = null), r
        );
      }
      return (
        l(t, e),
        f(t, [
          {
            ...
            value: function() {
              ...
              return (
                !!t &&
                (t.jsonLike ||
                  (t.type === T.Type.COMMENT && this.nodeIsJsonLike(e - 1)))
              );
            }
          },
          {
                ...
                switch (l) {
                  case "\n":
                    if (
                      ...
                      var d = new n.default();
                      (f = d.parse({ src: s }, f)), this.items.push(d);
                    }
                    if (
                      (c = a.default.endOfIndent(s, f)) <= f + u &&
                      ((l = s[c]), c < f + u || ("]" !== l && "}" !== l))
                    ) {
                      this.error = new x.YAMLSemanticError(
                        this,
                    ...
                    break;
                  case ",":
                    this.items.push({ char: l, offset: c }), (c += 1);
                    break;
                  case "#":
                    var h = new r.default();
                    (c = h.parse({ src: s }, c)), this.items.push(h);
                    break;
                  case "?":
                  case ":":
                    var p = s[c + 1];
                  ...
                  default:
                    ...
                    this.items.push(v),
                      (c = a.default.normalizeOffset(s, v.range.end));
                }
          ...
          },
          {
            ...
            value: function(e, n) {
              return (
                (n = m(c(t.prototype), "setOrigRanges", this).call(this, e, n)),
                this.items.forEach(function(t) {
                  if (t instanceof a.default) n = t.setOrigRanges(e, n);
              ...
              value: function(e) {
                for (
                  var r = this.context,
                    ...
                    u = e,
                    f = i[s];
                  "\n" === f && !n.default.atDocumentBoundary(i, s + 1);
                  f = i[s]
                ) {
            ...
            },
            {
              ...
              get: function() {
                ...
                var e = [],
                  ...
                  s = o.src;
                '"' !== s[a - 1] &&
                  e.push(new x.YAMLSyntaxError(this, 'Missing closing "quote'));
                for (var u = "", f = r + 1; f < a - 1; ++f) {
                  var l = s[f];
                  if ("\n" === l) {
                    n.default.atDocumentBoundary(s, f + 1) &&
                      e.push(
        ...
        s(this, e),
          (p = function(t, s) {
              ...
              default:
                return (
                  (f.error = new x.YAMLSyntaxError(
                    f,
                    "Unknown node type: ".concat(JSON.stringify(y))
                  )),
            ...
            if (
              ...
              b <= s &&
                ((f.error = new Error("Node#parse consumed no characters")),
                (f.error.parseEnd = b),
                (f.error.source = f),
                (f.range.end = s + 1)),
              ...
              return (
                (b = w.parse(new e(p), b)), (w.range = new h.default(s, b)), w
              );
            }
            return f;
          }),
            ...
            value: function(t) {
              for (
                var n = this.inFlow,
                  ...
                  o = [],
                  i = !1,
                  s = a[(t = u.default.endOfWhiteSpace(a, t))];
                s === T.Char.ANCHOR ||
                s === T.Char.COMMENT ||
                s === T.Char.TAG ||
                "\n" === s;
                ...
                if ("\n" === s) {
                  ...
                  s === T.Char.TAG &&
                    ...
                    (v = u.default.endOfIdentifier(a, v + 5)),
              ...
              return (
                i && ":" === s && u.default.atBlank(a, t + 1, !0) && (t -= 1),
          ...
          },
          {
            ...
            value: function(e, t, r) {
              ...
              var c =
                ...
                h = d.doc,
                p = d.indent;
              e = Object.assign({}, e, { implicitKey: !c, indent: p + "  " });
              var v = !1,
              ...
              if (((g = (0, n.default)(g, e.indent, l)), e.allNullValues && !s))
                return (
                  this.comment
              ...
              (g = c ? "? ".concat(g, "\n").concat(p, ":") : "".concat(g, ":")),
                this.comment &&
                  ((g = (0, n.default)(g, e.indent, this.comment)), t && t());
              var m = "",
                y = null;
              ...
              return (
                v && !y && r && r(), (0, n.default)(g + w + b, e.indent, y)
              );
            }
          },
          {
            ...
            set: function(e) {
              null == this.key && (this.key = new u.default(null)),
  ...
  var X = o(function(e, t) {
    ...
    var h = function(e) {
      return (
        null == e || ("object" === i(e) && e[Symbol.iterator]().next().done)
      );
    };
    t.isEmptyPath = h;
    var p = (function(e) {
      function t() {
        ...
        return (
          d(
            v((n = g(this, (e = c(t)).call.apply(e, [this].concat(a))))),
            "items",
            []
          ),
          n
          ...
          },
          {
            ...
            value: function(e, r, a, o) {
              var i = this,
                ...
                h = c.indent,
                p =
                  (this.type && "FLOW" === this.type.substr(0, 4)) || e.inFlow;
              p && (l += "  ");
              ...
              var g,
                ...
                _ = this.items.reduce(function(t, r, a) {
                  ...
                  r &&
                    ...
                    r.commentBefore &&
                      r.commentBefore.match(/^.*$/gm).forEach(function(e) {
          ...
          f(t, null, [
            {
              ...
              value: function(e, t) {
                ...
                if (
                  (!u && s && (u = o.anchors.getName(r) || o.anchors.newName()),
                  u)
                )
          ...
          f(t, [
            {
              ...
              value: function(e, t) {
                ...
                if (!i || void 0 === i.res) {
                  ...
                  throw this.cstNode
                    ? new x.YAMLReferenceError(this.cstNode, s)
                    : new ReferenceError(s);
                }
                if (
                  o >= 0 &&
                  ((i.count += 1),
                  0 === i.aliasCount && (i.aliasCount = p(this.source, a)),
                  i.count * i.aliasCount > o)
                ) {
                  var u =
                    "Excessive alias count indicates a resource exhaustion attack";
                  throw this.cstNode
                    ? new x.YAMLReferenceError(this.cstNode, u)
        ...
        f(t, [
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return (
                !!t && this.items.splice(this.items.indexOf(t), 1).length > 0
              );
            }
          },
          {
      ...
      function t(e) {
        ...
        if ((s(this, t), e instanceof r.default)) {
          ...
          i instanceof o.default ||
            ...
            ((n = g(this, c(t).call(this, e.key, i))).range = e.range);
        ...
        f(t, [
          {
            ...
            value: function(e, t) {
              ...
              try {
                for (
                  var i, s = this.value.items[Symbol.iterator]();
                  !(r = (i = s.next()).done);
                  r = !0
                ) {
          ...
          },
          {
            ...
            value: function(e, n) {
              var r = this.value;
              if (r.items.length > 1)
                return m(c(t.prototype), "toString", this).call(this, e, n);
  ...
  var fe = o(function(e, t) {
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.stringifyString = function(e, t, i, s) {
            ...
            case T.Type.PLAIN:
              return (function(e, t, i, s) {
                ...
                if (!d && !p && f !== T.Type.PLAIN && -1 !== l.indexOf("\n"))
                  return o(e, t, i, s);
                var g = l.replace(/\n+/g, "$&\n".concat(h));
                if (c && "string" != typeof v.resolveScalar(g).value)
                  return r(l, t);
                var m = d
                  ? g
                  : (0, n.default)(g, h, n.FOLD_FLOW, ue.strOptions.fold);
                if (
                  u &&
                  !p &&
                  (-1 !== m.indexOf("\n") || -1 !== u.indexOf("\n"))
        ...
        d !== T.Type.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(h)
          ? (d = T.Type.QUOTE_DOUBLE)
          : (!f && !l) ||
            (d !== T.Type.BLOCK_FOLDED && d !== T.Type.BLOCK_LITERAL) ||
            (d = T.Type.QUOTE_DOUBLE);
        var v = p(d);
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.checkFlowCollectionEnd = function(e, t) {
        ...
        switch (t.type) {
          ...
          default:
            return void e.push(
              new x.YAMLSemanticError(t, "Not a flow collection!?")
            );
        }
        ...
        if (a && a.char !== n) {
          ...
          "number" == typeof a.offset
            ? ((s = new x.YAMLSemanticError(t, u)).offset = a.offset + 1)
      ...
      (t.checkKeyLength = function(e, t, n, r, a) {
        ...
        if (i > a + 1024) {
          ...
          e.push(
            new x.YAMLSemanticError(t, 'The "'.concat(f, '" key is too long'))
          );
        }
      }),
        ...
        try {
          for (
            ...
            c
              ? (u && c.value && (c = c.value),
                void 0 === l
                  ? (!u && c.commentBefore) || (c.spaceBefore = !0)
                  : c.commentBefore
                  ? (c.commentBefore += "\n" + l)
                  : (c.commentBefore = l))
              : void 0 !== l &&
                    ...
                    if ("string" == typeof l.char) {
                      ...
                      l.type === T.Type.BLANK_LINE
                        ...
                        : ("," !== u &&
                          ...
                          r.push(new o.default(a, e.resolveNode(l))),
                          (a = void 0),
                          (s = !1));
                  }
                  ...
                  for (
                    ...
                    switch (f.type) {
                      case T.Type.BLANK_LINE:
                        r.push({ afterKey: !!i, before: a.length });
                        break;
                      case T.Type.COMMENT:
                        r.push({
                          afterKey: !!i,
                      ...
                      case T.Type.MAP_VALUE:
                        if (
                          ...
                          !f.context.atLineStart &&
                            f.node &&
                            f.node.type === T.Type.MAP &&
                            !f.node.context.atLineStart)
                        ) {
                          e.errors.push(
                            new x.YAMLSemanticError(
                              f.node,
                        ...
                        if (!c && f.props.length > 0) {
                          ...
                          if (
                            ((c.range = { start: d, end: d }),
                            (c.valueRange = { start: d, end: d }),
                        ...
                        l(f, p),
                          a.push(p),
                          (0, le.checkKeyLength)(e.errors, t, u, i, s),
                          (i = void 0),
                          (s = null);
                        break;
                      default:
              ...
              ? (function(e, t) {
                  for (
                    ...
                    if ("string" == typeof l.char) {
                      ...
                      r.push({ comment: l.comment, before: a.length });
                    else {
                      if (u) {
                      ...
                      void 0 === i
                        ? a.push(m)
                        : (a.push(new n.default(i, m)), (i = void 0)),
                        (s = l.range.start),
                        (u = ",");
                    }
                  }
    ...
    var a = r(ge).default.concat([
      ...
      },
      {
        ...
        resolve: function(e, t) {
          ...
          return (
            t && "0" === t[t.length - 1] && (r.minFractionDigits = t.length), r
          );
        },
        stringify: fe.stringifyNumber
      }
      ...
      t = Math.abs(t),
        isNaN(t) || t === 1 / 0
          ...
          : ((i = Math.floor(Math.log(t) / Math.LN2)),
            ...
            (t += i + c >= 1 ? d / u : d * Math.pow(2, 1 - c)) * u >= 2 &&
              (i++, (u /= 2)),
            i + c >= l
              ? ((s = 0), (i = l))
              : i + c >= 1
  ...
  function Be(e, t) {
    if ((Ie(t), (e = Ne(e, t < 0 ? 0 : 0 | je(t))), !xe.TYPED_ARRAY_SUPPORT))
  ...
  function pt(e) {
    return (function(e) {
      ...
      return (
        2 === o
          ? ((a = (we[e.charCodeAt(t)] << 2) | (we[e.charCodeAt(t + 1)] >> 4)),
            (i[u++] = 255 & a))
          : 1 === o &&
            ((a =
    ...
    function u(e, t, n) {
      ...
      try {
        for (
          ...
          if (Array.isArray(l)) {
            if (2 !== l.length)
              throw new TypeError("Expected [key, value] tuple: ".concat(l));
            (c = l[0]), (d = l[1]);
                ...
                for (
                  ...
                  if (
                    (l instanceof a.default
                      ? ((c = (0, n.default)(l.key, "", t)),
                        (d = (0, n.default)(l.value, c, t)))
                      : (c = (0, n.default)(l, "", t)),
                    r.has(c))
                  )
                    throw new Error(
            ...
            },
            {
              ...
              value: function(e, t) {
                ...
                a && !t
                  ...
                  : !a && t && this.items.push(new r.default(e));
              }
            },
            {
              key: "toJSON",
    ...
    var d = (function() {
      function e(t) {
        ...
        if (
          (!n &&
            o &&
            ((n = o), (0, ie.warnOptionDeprecation)("tags", "customTags")),
          Array.isArray(n))
        ) {
          var u = !0,
            f = !1,
          ...
          if ("string" == typeof v) {
            ...
            if (!g) {
              var m = Object.keys(Ot.tags)
                ...
                .join(", ");
              throw new Error(
                'Unknown custom tag "'.concat(v, '"; use one of ').concat(m)
              );
            }
            this.tags[p] = g;
          }
        ...
        f(e, [
            ...
            value: function(t, r, a, o) {
              ...
              if (a) {
                ...
                if (
                  ...
                  throw new Error("Tag ".concat(a, " not found"));
              } else if (
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              for (var n = 0; n < t.length; ++n) {
                ...
                if (o) {
                  ...
                  if (s) {
                    ...
                    return (
                      f instanceof u.default || (f = new u.default(f)),
                      a && (f.format = a),
                      f
                    );
                  }
              ...
              return (
                this.tags.scalarFallback && (e = this.tags.scalarFallback(e)),
                new u.default(e)
              );
            }
          },
          {
            ...
            value: function(e, t, n) {
              ...
              try {
                if (o) {
                  var i = o.resolve(e, t);
                  i instanceof r.default || (i = new u.default(i)),
                    (t.resolved = i);
                } else {
          ...
          },
          {
            ...
            value: function(t, n, r) {
              ...
              var o,
                i =
                  (o = n.type) === T.Type.FLOW_MAP || o === T.Type.MAP
                    ? e.defaultTags.MAP
                    : (function(e) {
                        var t = e.type;
            ...
            value: function(e, t, n) {
              ...
              return (
                ...
                e.tag
                  ...
                  : t.default || o.push(a.stringifyTag(t.tag)),
                o.join(" ")
              );
            }
          },
          {
            ...
            value: function(e, t, n, i) {
              ...
              if (!(e instanceof a.default)) {
                ...
                try {
                  for (
                    var h, p = u.aliasNodes[Symbol.iterator]();
                    !(l = (h = p.next()).done);
                    l = !0
                  ) {
                    var v = h.value;
              ...
              return m
                ? e instanceof r.default && "{" !== y[0] && "[" !== y[0]
                  ? ""
                      .concat(m, "\n")
                      .concat(t.indent)
                      .concat(y)
        ...
        return (
          f(e, [
            ...
            },
            {
              ...
              value: function(e) {
                return (
                  this.contents instanceof u.default && this.contents.has(e)
                );
              }
            },
            {
            ...
            },
            {
              ...
              value: function(e, t) {
                ...
                var n = e.directives,
                  ...
                  u = e.valueRange;
                if (
                  (s && (s.source || (s.source = this), this.errors.push(s)),
                  ...
                  try {
                    for (
                      var d, h = this.errors[Symbol.iterator]();
                      !(f = (d = h.next()).done);
                      f = !0
                    ) {
                      var p = d.value;
                  ...
                  try {
                    for (
                      var y, _ = this.warnings[Symbol.iterator]();
                      !(v = (y = _.next()).done);
                      v = !0
                    ) {
                      var b = y.value;
              ...
              value: function(e, t) {
                ...
                if (
                  ...
                  t &&
                    !a &&
                    "1.1" ===
                      (this.version || t.version || this.options.version))
                ) {
                  ...
                  if (s) {
                    ...
                    if (f) {
                      ...
                      this.errors.push(
                        new x.YAMLSemanticError(
                          e,
                          "The ".concat(a, " tag has no suffix.")
                        )
                      );
                    } else {
                      var d = "The ".concat(
            ...
            },
            {
              ...
              value: function(e) {
                ...
                if (e.type === T.Type.ALIAS) {
                  ...
                  if (A) t = a.resolveNodeWithFallback(this, e, A);
                  else {
            ...
            },
            {
              ...
              value: function() {
                ...
                if (this.contents) {
                  ...
                  void 0 !== this.contents &&
                    e.push(this.schema.stringify(this.contents, o));
                return (
                  this.comment &&
                    ((i && !s) || "" === e[e.length - 1] || e.push(""),
      ...
      (t.attachComments = function(e) {
            ...
            return (
              (function e(t, n) {
                ...
                if ("leadingComments" in n) {
                  ...
                  (!a || r.column < a.position.start.column) &&
                ...
                if (
                  ...
                  (!i || o.column >= i.position.end.column) &&
                    (t[o.line - 1].trailingAttachableNode = n);
                }
                if (
                  "root" !== n.type &&
                  "document" !== n.type &&
                  ...
                  for (
                    ...
                    (!d || o.column >= d.position.end.column) &&
        ...
        e.comments
          ...
          .forEach(function(e) {
            for (
              ;
              r.length > 1 && e.position.start.line > r[0].position.end.line;
            ...
            !(function(e, t, r) {
              ...
              for (var i = a; i >= r.position.start.line; i--) {
                ...
                for (;;) {
                  if (n(u, e))
                    return Lt.defineParents(e, u), void u.endComments.push(e);
                  if (!u._parent) break;
                  u = u._parent;
                }
                break;
              ...
              for (i = a + 1; i <= r.position.end.line; i++) {
                ...
                if (f)
                  return Lt.defineParents(e, f), void f.leadingComments.push(e);
              }
              var l = r.children[1];
        ...
        for (
          ...
          switch (c) {
            ...
            case Wt.PropLeadingCharacter.Anchor:
              (o = o || l),
                (s = Qt.createAnchor(t.transformRange(l), r.anchor));
              break;
            ...
            default:
              throw new Error(
                "Unexpected leading character " + JSON.stringify(c)
              );
          }
        }
  ...
  var zt = o(function(e, t) {
    (t.__esModule = !0),
      (t.createBlockLiteral = function(e) {
        return xt.__assign(xt.__assign({}, e), { type: "blockLiteral" });
      });
  });
  a(zt);
      ...
      (t.extractPropComments = function(e, t) {
        for (var n = 0, r = e.props; n < r.length; n++) {
          ...
          switch (o) {
            ...
            default:
              throw new Error(
                "Unexpected leading character " + JSON.stringify(o)
              );
          }
        }
      });
    ...
    (t.__esModule = !0),
      (t.transformDirective = function(e, t) {
        return (
          ...
          en.createDirective(t.transformRange(e.range), e.name, e.parameters)
        );
      });
  });
  a(nn);
    ...
    (t.__esModule = !0),
      (t.transformDocumentBody = function(e, t, n) {
        var r,
          ...
          o = (function(e, t, n) {
            for (
              var r = [], a = [], o = [], i = !1, s = e.contents.length - 1;
              s >= 0;
              s--
            ) {
              var u = e.contents[s];
              if ("COMMENT" === u.type) {
                ...
                n && n.line === f.position.start.line
                  ...
                  : i
                  ? r.unshift(f)
                  : f.position.start.offset >= e.valueRange.origEnd
                  ? a.unshift(f)
                  : r.unshift(f);
              } else i = !0;
            }
          ...
          c = (function(e, t, n) {
            ...
            var o = n.transformRange({
              ...
              i =
                -1 === r ? o.end : n.transformOffset(e.valueRange.origEnd + 3);
    ...
    (t.__esModule = !0),
      (t.transformDocumentHead = function(e, t) {
        var n,
          ...
          a = (function(e, t) {
            for (
              var n = [], r = [], a = [], o = !1, i = e.directives.length - 1;
              i >= 0;
              i--
            ) {
  ...
  var hn = o(function(e, t) {
    (t.__esModule = !0),
      (t.transformDocument = function(e, t) {
        ...
        return (
          u && t.comments.push(u),
          rn.createDocument(an.createPosition(f.position.start, s), f, i, u)
        );
      });
  });
  a(hn);
    ...
    (t.__esModule = !0),
      (t.transformAstPair = function(e, t, n, r, a) {
        ...
        return n(
          ...
          s ||
            wn.createMappingKey(an.createEmptyPosition(u.position.start), null),
          u ||
            En.createMappingValue(an.createEmptyPosition(s.position.end), null)
        );
      });
  });
  a(On);
          ...
          a = e.items.map(function(e, n) {
            if ("PAIR" !== e.type) {
              ...
              return An.createFlowSequenceItem(
                an.createPosition(a.position.start, a.position.end),
                a
              );
            }
            var o = r[n],
  ...
  var Pn = o(function(e, t) {
    (t.__esModule = !0),
      (t.transformMap = function(e, t) {
        ...
        var r = (function(e) {
            for (
              var t = [], n = _n.createSlicer(e, 0), r = !1, a = 0;
              a < e.length;
              a++
            ) {
              "MAP_VALUE" !== e[a].type
          ...
          a = e.items.map(function(e, n) {
            var a = r[n],
              o =
                "MAP_VALUE" === a[0].type
                  ? [null, a[0].range]
                  : [a[0].range, 1 === a.length ? null : a[1].range],
              i = o[0],
              s = o[1];
            return On.transformAstPair(e, t, Tn.createMappingItem, i, s);
          });
        return Ln.createMapping(
          an.createPosition(a[0].position.start, un.getLast(a).position.end),
          t.transformContent(e),
          a
        );
      });
      ...
      (t.transformPlain = function(e, t) {
        ...
        return Cn.createPlain(
          t.transformRange({
            ...
            origEnd:
              Nn.findLastCharIndex(t.text, n.valueRange.origEnd - 1, /\S/) + 1
          }),
          t.transformContent(e),
          n.strValue
        );
  ...
  var In = o(function(e, t) {
    (t.__esModule = !0),
      (t.createQuoteValue = function(e, t, n) {
        return xt.__assign(
          xt.__assign(
            xt.__assign(xt.__assign({}, Ct.createNode("quoteValue", e)), t),
            jt.createCommentAttachable()
          ),
          { value: n }
        );
    ...
    (t.__esModule = !0),
      (t.transformSeq = function(e, t) {
        ...
        return Fn.createSequence(
          an.createPosition(n[0].position.start, un.getLast(n).position.end),
          t.transformContent(e),
          n
        );
      });
  ...
  var Qn = o(function(e, t) {
    (t.__esModule = !0),
      (t.createError = function(e, t, n) {
        ...
        return (
          (r.name = "YAMLSyntaxError"), (r.source = t), (r.position = n), r
        );
      });
  });
  a(Qn);
        ...
        if (null !== t && "children" in t) {
          ...
          if ((u.forEach(e), "document" === t.type)) {
            ...
            l.position.start.offset === l.position.end.offset
              ? (l.position.start = l.position.end = c.position.start)
              : c.position.start.offset === c.position.end.offset &&
                (c.position.start = c.position.end = l.position.end);
          }
          ...
          if (0 !== p.length) {
            ...
            d(v.position.start),
              ...
              "anchor" in v && v.anchor && d(v.anchor.position.start),
    ...
    (t.__esModule = !0),
      (t.parse = function(e) {
        ...
        var n = t.map(function(e) {
            return new kt.Document({ merge: !0, keepCstNodes: !0 }).parse(e);
          }),
          r = [],
          a = {
            text: e,
        ...
        return (
          Pt.attachComments(i), Zn.updatePositions(i), Hn.removeFakeNodes(i), i
        );
      });
  });
  a(Xn);
