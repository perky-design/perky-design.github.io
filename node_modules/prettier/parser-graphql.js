        ...
        o && t
          ...
          : l &&
            (f = l.reduce(function(e, n) {
              return (
                n.loc && e.push((0, u.getLocation)(n.loc.source, n.loc.start)),
                e
              );
            }, []));
      var T = c;
          ...
          return (function(e, n, t, i, r, s) {
            ...
            if (48 === l) {
              if ((l = u.charCodeAt(++d)) >= 48 && l <= 57)
                throw (0, E.syntaxError)(
                  e,
                  d,
                  "Invalid number, unexpected digit after 0: ".concat(a(l), ".")
                );
            ...
            if (46 === l || 69 === l || 101 === l)
              throw (0, E.syntaxError)(
                e,
                d,
                "Invalid number, expected digit but got: ".concat(a(l), ".")
              );
            return new o(
                ...
                for (; u < c.length && !isNaN((d = c.charCodeAt(u))); ) {
                  ...
                  if (d < 32 && 9 !== d && 10 !== d && 13 !== d)
                    throw (0, E.syntaxError)(
                      e,
                      u,
                      "Invalid character within String: ".concat(a(d), ".")
                    );
                  10 === d
                    ? (++u, ++s.line, (s.lineStart = u))
                    : 13 === d
                    ? (10 === c.charCodeAt(u + 1) ? (u += 2) : ++u,
                      ++s.line,
                      (s.lineStart = u))
                    : 92 === d &&
                      34 === c.charCodeAt(u + 1) &&
            ...
            : (function(e, n, t, i, r) {
                ...
                for (
                  ...
                  if (34 === d)
                    return (
                      (f += s.slice(l, c)),
                      new o(p.TokenKind.STRING, n, c + 1, t, i, r, f)
                    );
                  if (d < 32 && 9 !== d)
                    throw (0, E.syntaxError)(
                      e,
      ...
      throw (0, E.syntaxError)(
        ...
        (function(e) {
          if (e < 32 && 9 !== e && 10 !== e && 13 !== e)
            return "Cannot contain the invalid character ".concat(a(e), ".");
          if (39 === e)
    ...
    var s = (function() {
      function e(e, n) {
        ...
        r instanceof c.Source ||
          (0, i.default)(
            0,
            "Must provide Source. Received: ".concat((0, t.default)(r))
          ),
      ...
      return (
        (n.parseName = function() {
          ...
          return { kind: d.Kind.NAME, value: e.value, loc: this.loc(e) };
        }),
        ...
        (n.parseVariableDefinition = function() {
          ...
          return {
            ...
            type:
              (this.expectToken(p.TokenKind.COLON), this.parseTypeReference()),
        ...
        (n.parseVariable = function() {
          ...
          return (
            ...
            { kind: d.Kind.VARIABLE, name: this.parseName(), loc: this.loc(e) }
          );
        }),
        ...
        (n.parseConstArgument = function() {
          ...
          return {
            ...
            name: this.parseName(),
            value:
              (this.expectToken(p.TokenKind.COLON), this.parseValueLiteral(!0)),
            loc: this.loc(e)
          };
        }),
        ...
        (n.parseValueLiteral = function(e) {
          ...
          switch (n.kind) {
            ...
            case p.TokenKind.INT:
              return (
                this._lexer.advance(),
                { kind: d.Kind.INT, value: n.value, loc: this.loc(n) }
              );
            case p.TokenKind.FLOAT:
              return (
                this._lexer.advance(),
                { kind: d.Kind.FLOAT, value: n.value, loc: this.loc(n) }
              );
            ...
            case p.TokenKind.NAME:
              return "true" === n.value || "false" === n.value
                ...
                : (this._lexer.advance(),
                  { kind: d.Kind.ENUM, value: n.value, loc: this.loc(n) });
          ...
          return (
            this.expectOptionalToken(p.TokenKind.BRACKET_L)
              ? ((e = this.parseTypeReference()),
                ...
                (e = { kind: d.Kind.LIST_TYPE, type: e, loc: this.loc(n) }))
              : (e = this.parseNamedType()),
            this.expectOptionalToken(p.TokenKind.BANG)
              ? { kind: d.Kind.NON_NULL_TYPE, type: e, loc: this.loc(n) }
              : e
          );
        }),
        ...
        (n.peekDescription = function() {
          return (
            this.peek(p.TokenKind.STRING) || this.peek(p.TokenKind.BLOCK_STRING)
          );
        }),
        ...
        (n.loc = function(e) {
          if (!this._options.noLocation)
            return new u(e, this._lexer.lastToken, this._lexer.source);
        }),
        (n.peek = function(e) {
      ...
      (n.visit = function(e, n) {
        ...
        do {
          ...
          if (N) {
            ...
            if (((h = T ? (u ? d : l[d]) : void 0), null == (f = T ? T[h] : y)))
              continue;
            T && v.push(h);
          }
          var b = void 0;
          if (!Array.isArray(f)) {
            if (!a(f))
              throw new Error("Invalid AST Node: " + (0, i.default)(f));
            var S = s(n, f.kind, N);
            if (S) {
          ...
          void 0 === b && m && p.push([h, f]),
            N
              ? v.pop()
              : ((c = { inArray: u, index: d, keys: l, edits: p, prev: c }),
                (u = Array.isArray(f)),
                (l = u ? f : t[f.kind] || []),
                (d = -1),
                (p = []),
  ...
  var O = o(function(e, n) {
    ...
    var t = {
      ...
      StringValue: function(e, n) {
        var t = e.value;
        return e.block
          ? (0, y.printBlockString)(t, "description" === n ? "" : "  ")
          : JSON.stringify(t);
      },
      ...
      ObjectTypeExtension: function(e) {
        var n = e.name,
          ...
          s = e.fields;
        return r(
          ["extend type", n, a("implements ", r(t, " & ")), r(i, " "), o(s)],
          " "
        );
      },
              ...
              return (
                (r.comments = (function(e) {
                  for (
                    ...
                    "Comment" === t.kind &&
                      (Object.assign(t, { column: t.column - 1 }), n.push(t)),
                      (t = t.next);
                  return n;
                })(r)),
                (function e(t) {
