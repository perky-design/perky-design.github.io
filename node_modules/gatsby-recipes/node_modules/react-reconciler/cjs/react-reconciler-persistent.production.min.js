...
module.exports = function $$$reconciler($$$hostConfig) {
    ...
    do {
      a: switch (a.tag) {
        ...
        default:
          ...
          e
            ? (f =
                " (at " + e.fileName.replace(yb, "") + ":" + e.lineNumber + ")")
            : c && (f = " (created by " + c + ")");
          c = "\n    in " + (d || "Unknown") + f;
      }
      b += c;
  ...
  function sc(a, b) {
    a = a.type._context;
    Pa
      ? (C(nc, a._currentValue), (a._currentValue = b))
      : (C(nc, a._currentValue2), (a._currentValue2 = b));
  }
  function tc(a) {
    var b = nc.current;
    B(nc);
  ...
  function vc(a, b) {
    ...
    null !== a &&
      null !== a.firstContext &&
      (a.expirationTime >= b && (wc = !0), (a.firstContext = null));
  }
  function I(a, b) {
    if (qc !== a && !1 !== b && 0 !== b) {
  ...
  function Sc(a, b, c, d) {
    ...
    "object" === typeof f && null !== f
      ? (e.context = I(f))
      : ((f = F(b) ? Db : D.current), (e.context = Eb(a, f)));
    Dc(a, c, e, d);
    e.state = a.memoizedState;
  ...
  function Wc(a) {
    ...
    function h(b, a, c, d) {
      if (null === a || 6 !== a.tag)
        return (a = Yc(c, b.mode, d)), (a.return = b), a;
      a = e(a, c);
      a.return = b;
      return a;
    }
    ...
    function q(b, a, c, d, f) {
      if (null === a || 7 !== a.tag)
        return (a = ad(c, b.mode, d, f)), (a.return = b), a;
      a = e(a, c);
      a.return = b;
      return a;
    }
    function r(a, b, c) {
      if ("string" === typeof b || "number" === typeof b)
        return (b = Yc("" + b, a.mode, c)), (b.return = a), b;
      if ("object" === typeof b && null !== b) {
        ...
        if (Tc(b) || sa(b))
          return (b = ad(b, a.mode, c, null)), (b.return = a), b;
        Vc(a, b);
      }
      return null;
    }
    function w(b, a, c, d) {
      ...
      if ("string" === typeof c || "number" === typeof c)
        return null !== e ? null : h(b, a, "" + c, d);
      if ("object" === typeof c && null !== c) {
        switch (c.$$typeof) {
          case ca:
            return c.key === e
              ? c.type === ea
                ? q(b, a, c.props.children, d, e)
                : k(b, a, c, d)
              : null;
          case da:
    ...
    function z(b, a, c, d, e) {
      if ("string" === typeof d || "number" === typeof d)
        return (b = b.get(c) || null), h(a, b, "" + d, e);
        ...
        switch (d.$$typeof) {
          case ca:
            return (
              ...
              d.type === ea
                ? q(a, b, d.props.children, e, d.key)
                : k(a, b, d, e)
            );
          case da:
            return (
              (b = b.get(null === d.key ? c : d.key) || null), l(a, b, d, e)
            );
        }
    ...
    function Q(e, g, h, k) {
      for (
        var l = null, v = null, t = g, x = (g = 0), q = null;
        null !== t && x < h.length;
        x++
      ) {
    ...
    function A(e, g, h, k) {
      ...
      for (
        var l = (t = null), v = g, x = (g = 0), q = null, y = h.next();
        null !== v && !y.done;
        x++, y = h.next()
      ) {
    ...
    return function(a, d, f, h) {
      var k =
        "object" === typeof f && null !== f && f.type === ea && null === f.key;
        ...
        switch (f.$$typeof) {
          case ca:
            a: {
              ...
              f.type === ea
                ? ((d = ad(f.props.children, a.mode, h, f.key)),
                  (d.return = a),
                  (a = d))
  ...
  function ld(a) {
    for (var b = a; null !== b; ) {
      if (13 === b.tag) {
        ...
        if (null !== c && ((c = c.dehydrated), null === c || pb(c) || qb(c)))
          return b;
  ...
  function Cd(a, b, c) {
    ...
    f = a.alternate;
    if (a === M || (null !== f && f === M))
      (pd = !0), (e.expirationTime = od), (M.expirationTime = od);
    else {
      if (
        0 === a.expirationTime &&
  ...
  function Wd(a, b) {
    switch (a.tag) {
      case 5:
        return (
          (b = nb(b, a.type, a.pendingProps)),
          null !== b ? ((a.stateNode = b), !0) : !1
        );
      case 6:
        return (
          (b = ob(b, a.pendingProps)), null !== b ? ((a.stateNode = b), !0) : !1
        );
      case 13:
        return !1;
      default:
  ...
  function je(a, b, c, d, e, f) {
    ...
    b.effectTag |= 1;
    null !== a && g
      ? ((b.child = bd(b, a.child, null, f)), (b.child = bd(b, null, h, f)))
      : R(a, b, h, f);
  ...
  function le(a) {
    var b = a.stateNode;
    b.pendingContext
      ? Gb(a, b.pendingContext, b.pendingContext !== b.context)
      : b.context && Gb(a, b.context, !1);
  ...
  function ce(a, b, c) {
    ...
    if (null !== b.child) {
      ...
      for (c.return = b; null !== a.sibling; )
        (a = a.sibling),
          (c = c.sibling = Xc(a, a.pendingProps)),
          (c.return = b);
      c.sibling = null;
    }
    return b.child;
      ...
      for (var e = b.child; null !== e; ) {
        if (5 === e.tag) {
          ...
          if (
            ...
            if (
              null !== g &&
              (null !== g.child && ((g.child.return = g), se(a, g, !0, f)),
              (f = g.sibling),
              null !== f)
            ) {
              f.return = e;
      ...
      for (var e = b.child; null !== e; ) {
        if (5 === e.tag) {
          ...
          if (
            ...
            if (
              null !== g &&
              (null !== g.child && ((g.child.return = g), we(a, g, !0, f)),
              (f = g.sibling),
              null !== f)
            ) {
              f.return = e;
      ...
      case 1:
        if (b.effectTag & 256 && null !== a) {
          ...
          b = a.getSnapshotBeforeUpdate(
            b.elementType === b.type ? c : mc(b.type, c),
            d
          );
    ...
    switch (c.tag) {
      ...
      case 13:
        Sa &&
          ...
          null !== c &&
            ((c = c.memoizedState),
            null !== c && ((c = c.dehydrated), null !== c && xb(c))));
        return;
      case 19:
      case 17:
      case 20:
  ...
  function Ye(a, b, c) {
    ...
    if (e)
      ...
      for (Ye(a, b, c), a = a.sibling; null !== a; )
  ...
  function Ze(a, b, c) {
    ...
    if (e)
      ...
      for (Ze(a, b, c), a = a.sibling; null !== a; )
  ...
  function $e(a, b) {
    if (Qa) {
      switch (b.tag) {
        ...
        case 3:
          Sa &&
            ((b = b.stateNode),
            b.hydrate && ((b.hydrate = !1), wb(b.containerInfo)));
          return;
        case 12:
          return;
        case 13:
    ...
    switch (b.tag) {
      ...
      case 3:
        Sa &&
          ((c = b.stateNode),
          c.hydrate && ((c.hydrate = !1), wb(c.containerInfo)));
    }
    a: if (Ra) {
      switch (b.tag) {
        case 1:
  ...
  function jf(a, b, c) {
    ...
    null !== f &&
      ...
      (c.callback = function() {
        "function" !== typeof d &&
          (null === kf ? (kf = new Set([this])) : kf.add(this), Ie(a, b));
        var c = b.stack;
  ...
  function Nc(a, b) {
    ...
    if (null !== a) {
      ...
      (W & 4) === V ||
        ...
        (null === Df
          ? (Df = new Map([[a, b]]))
          : ((c = Df.get(a)), (void 0 === c || c > b) && Df.set(a, b)));
    }
  }
  function Hf(a, b) {
    a.expirationTime < b && (a.expirationTime = b);
  ...
  function Z(a) {
    if (0 !== a.lastExpiredTime)
      (a.callbackExpirationTime = 1073741823),
        ...
        (a.callbackNode = fc(If.bind(null, a)));
    else {
      var b = Jf(a),
        c = a.callbackNode;
      if (0 === b)
        ...
        b =
          1073741823 === b
            ? fc(If.bind(null, a))
            : ec(d, Lf.bind(null, a), { timeout: 10 * (1073741821 - b) - G() });
        a.callbackNode = b;
      }
    }
  }
            ...
            case tf:
              if (1073741823 !== vf && null !== xf) {
                ...
                0 >= d
                  ...
                  : ((e = g.busyDelayMs | 0),
                    (f =
                      G() - (10 * (1073741821 - f) - (g.timeoutMs | 0 || 5e3))),
                    (d = f <= e ? 0 : e + d - f));
                if (10 < d) {
                  De(a, c);
                  a.timeoutHandle = Ma(Tf.bind(null, a), d);
              ...
              if ((w = 13 === r.tag)) {
                ...
                if (null !== z) w = null !== z.dehydrated ? !0 : !1;
                  ...
                  w =
                    void 0 === Q.fallback
                      ? !1
                      : !0 !== Q.unstable_avoidThisFallback
                      ? !0
                      : q
                      ? !1
                      : !0;
              ...
              case 1:
                ...
                if (
                  ...
                  ("function" === typeof $f.getDerivedStateFromError ||
                    (null !== Fc &&
                      "function" === typeof Fc.componentDidCatch &&
                      (null === kf || !kf.has(Fc))))
                ) {
                  r.effectTag |= 4096;
                  r.expirationTime = b;
      ...
      case 3:
        ...
        if (d === e) $d(), (b = ce(a, b, c));
          ...
          if ((e = b.stateNode.hydrate))
            Sa
              ? ((Sd = sb(b.stateNode.containerInfo)), (Rd = b), (e = Td = !0))
              : (e = !1);
          if (e)
