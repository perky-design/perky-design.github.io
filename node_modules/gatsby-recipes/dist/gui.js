    ...
    const RecipeInterpreter = () => {
      ...
      if (showRecipesList) {
        return (0, _themeUi.jsx)(
          Wrapper,
          null,
          (0, _themeUi.jsx)(WelcomeMessage, null),
          (0, _themeUi.jsx)(Text, null, "Select a recipe to run"),
          (0, _themeUi.jsx)(RecipesList, {
        ...
        return (0, _themeUi.jsx)(
          ...
          state.context.plan.map((p, i) =>
            (0, _themeUi.jsx)(
              ...
              (0, _themeUi.jsx)(Text, null, p.resourceName, ":"),
              (0, _themeUi.jsx)(
                Text,
                null,
                ` `,
      ...
      return (0, _themeUi.jsx)(
        Wrapper,
        null,
        (0, _themeUi.jsx)(Div, null),
        state.context.currentStep === 0 &&
          (0, _themeUi.jsx)(WelcomeMessage, null),
        (0, _themeUi.jsx)("br", null),
        (0, _themeUi.jsx)("h2", null, "Proposed changes"),
        (0, _themeUi.jsx)("button", null, "Apply changes"),
        (0, _themeUi.jsx)(
          "div",
          null,
          "count ",
          (_state$context$plan = state.context.plan) === null ||
            _state$context$plan === void 0
            ? void 0
            : _state$context$plan.length
        ),
        (0, _themeUi.jsx)(
          "div",
          {
          ...
          (_state$context$plan2 = state.context.plan) === null ||
            _state$context$plan2 === void 0
            ? void 0
            : _state$context$plan2.map(p =>
                (0, _themeUi.jsx)(
                  "div",
                  null,
                  p.resourceName,
    ...
    const Wrapper = () =>
      (0, _themeUi.jsx)(
        ...
        (0, _themeUi.jsx)(
          ...
          (0, _themeUi.jsx)(Text, null, ` `),
          (0, _themeUi.jsx)(RecipeInterpreter, null)
        )
      );
