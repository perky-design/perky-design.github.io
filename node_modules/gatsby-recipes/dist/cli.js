...
const log = (label, textOrObj) => {
  if (process.env.DEBUG) {
    ...
    logStream =
      (_logStream = logStream) !== null && _logStream !== void 0
        ? _logStream
        : fs.createWriteStream(`recipe-client.log`, {
            flags: `a`
          });
...
module.exports = async ({ recipe, graphqlPort, projectRoot }) => {
  try {
    ...
    const RecipeInterpreter = () => {
      const { exit } = useApp(); // eslint-disable-next-line
      ...
      if (showRecipesList) {
        return /*#__PURE__*/ React.createElement(
          React.Fragment,
          null,
          /*#__PURE__*/ React.createElement(WelcomeMessage, null),
          /*#__PURE__*/ React.createElement(
            Text,
            {
              bold: true,
          ...
          /*#__PURE__*/ React.createElement(RecipesList, {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          state.context.plan.map((p, i) =>
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Text, null, " * ", p.describe),
              p.diff &&
                p.diff !== `` &&
                /*#__PURE__*/ React.createElement(
                  React.Fragment,
                  ...
                  /*#__PURE__*/ React.createElement(Text, null, p.diff),
                  /*#__PURE__*/ React.createElement(Text, null, "---")
                )
            )
          ),
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        !isDone &&
          /*#__PURE__*/ React.createElement(PresentStep, {
            state: state
          }),
        !isDone &&
    ...
    const Wrapper = () =>
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(Text, null, ` `),
          /*#__PURE__*/ React.createElement(RecipeInterpreter, null)
        )
      );
    ...
    const { waitUntilExit } = render(
      /*#__PURE__*/ React.createElement(Recipe, null),
      {
        experimental: true
      }
    );
