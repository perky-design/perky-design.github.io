...
(function() {
  ...
  (ref$ = require("./config")),
    ...
    (libraryBlacklist = ref$.libraryBlacklist),
    (es5SpecialCase = ref$.es5SpecialCase),
    (banner = ref$.banner);
  (ref$ = require("fs")),
  ...
  module.exports = function(arg$) {
    var modules,
      ...
      umd,
      this$ = this;
    (modules = (ref$ = arg$.modules) != null ? ref$ : []),
      (blacklist = (ref$ = arg$.blacklist) != null ? ref$ : []),
      (library = (ref$ = arg$.library) != null ? ref$ : false),
      (umd = (ref$ = arg$.umd) != null ? ref$ : true);
    return new Promise(function(resolve, reject) {
      (function() {
        ...
        modules.reduce(function(memo, it) {
          memo[it] = true;
          return memo;
        }, {})
      ));
