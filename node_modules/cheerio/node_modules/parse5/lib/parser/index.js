...
Parser.prototype.runParsingLoopForCurrentChunk = function(
  writeCallback,
  scriptHandler
) {
...
function listItemStartTagInBody(p, token) {
  ...
  for (var i = p.openElements.stackTop; i >= 0; i--) {
    ...
    if (tn === $.LI && elementTn === $.LI) closeTn = $.LI;
    else if (
      (tn === $.DD || tn === $.DT) &&
...
function startTagInBody(p, token) {
  ...
  switch (tn.length) {
    ...
    case 2:
      ...
      else if (tn === $.RB) rbStartTagInBody(p, token);
      else if (tn === $.RT || tn === $.RP) rtStartTagInBody(p, token);
    ...
    case 3:
      ...
      else if (tn === $.RTC) rbStartTagInBody(p, token);
    ...
    case 4:
      ...
      else if (tn === $.MAIN) addressStartTagInBody(p, token);
      ...
      else if (tn === $.MENU) menuStartTagInBody(p, token);
    ...
    case 7:
      if (tn === $.BGSOUND) startTagInHead(p, token);
      else if (
        tn === $.DETAILS ||
        tn === $.ADDRESS ||
        tn === $.ARTICLE ||
    ...
    case 8:
      if (tn === $.BASEFONT) startTagInHead(p, token);
      else if (tn === $.MENUITEM) menuitemStartTagInBody(p, token);
