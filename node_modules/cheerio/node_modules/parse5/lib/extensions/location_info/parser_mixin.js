...
LocationInfoParserMixin.prototype._setEndLocation = function(
  element,
  closingToken
) {
...
LocationInfoParserMixin.prototype._getOverriddenMethods = function(mxn, orig) {
  return {
    _bootstrap: function(document, fragmentContext) {
      ...
      mxn.posTracker = new PositionTrackingPreprocessorMixin(
    ...
    _insertTemplate: function(token) {
      ...
      var tmplContent = this.treeAdapter.getTemplateContent(
      ...
      var hasFosterParent = this._shouldFosterParentOnInsertion(),
        ...
        textNodeIdx =
          hasFosterParent && mxn.lastFosterParentingLocation.beforeElement
            ? siblings.indexOf(mxn.lastFosterParentingLocation.beforeElement) -
              1
            : siblings.length - 1,
