...
function getApiUrl(opts) {
  return (
    github(opts.pkg).replace("github.com", "api.github.com/repos") + "/releases"
  );
}
...
function urlTemplate(opts) {
  ...
  return (
    github(opts.pkg) + "/releases/download/{tag_prefix}{version}/" + packageName
  );
}
...
function getHostMirrorUrl(opts) {
  var propName =
    "npm_config_" +
    (opts.pkg.name || "").replace(/[^a-zA-Z0-9]/g, "_") +
    "_binary_host";
