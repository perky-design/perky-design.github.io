...
var SourceFileOperations = [
  [
    /Nan::SetMethod\(target,[\s]*\"(.*)\"[\s]*,[\s]*([^)]+)\)/g,
    'exports.Set(Napi::String::New(env, "$1"), Napi::Function::New(env, $2))'
  ],

  [
    /v8::Local<v8::FunctionTemplate>\s+(\w+)\s*=\s*Nan::New<FunctionTemplate>\([\w\d:]+\);(?:\w+->Reset\(\1\))?\s+\1->SetClassName\(Nan::String::New\("(\w+)"\)\);/g,
    'Napi::Function $1 = DefineClass(env, "$2", {'
  ],
  [
    /Local<FunctionTemplate>\s+(\w+)\s*=\s*Nan::New<FunctionTemplate>\([\w\d:]+\);\s+(\w+)\.Reset\((\1)\);\s+\1->SetClassName\((Nan::String::New|Nan::New<(v8::)*String>)\("(.+?)"\)\);/g,
    'Napi::Function $1 = DefineClass(env, "$6", {'
  ],
  [
    /Local<FunctionTemplate>\s+(\w+)\s*=\s*Nan::New<FunctionTemplate>\([\w\d:]+\);(?:\w+->Reset\(\1\))?\s+\1->SetClassName\(Nan::String::New\("(\w+)"\)\);/g,
    'Napi::Function $1 = DefineClass(env, "$2", {'
  ],
  [
    /Nan::New<v8::FunctionTemplate>\(([\w\d:]+)\)->GetFunction\(\)/g,
    "Napi::Function::New(env, $1)"
  ],
  [
    /Nan::New<FunctionTemplate>\(([\w\d:]+)\)->GetFunction()/g,
    "Napi::Function::New(env, $1);"
  ],
  [
    /Nan::New<v8::FunctionTemplate>\(([\w\d:]+)\)/g,
    "Napi::Function::New(env, $1)"
  ],
  ...
  [
    /([ ]*)Nan::SetPrototypeMethod\(\w+, "(\w+)", (\w+)\);/g,
    '$1InstanceMethod("$2", &$3),'
  ],
  [
  ...
  [
    /\*Nan::Utf8String\(([^)]+)\)/g,
    "$1->As<Napi::String>().Utf8Value().c_str()"
  ],
  [
    /Nan::Utf8String +(\w+)\(([^)]+)\)/g,
    "std::string $1 = $2.As<Napi::String>()"
  ],
  ...
  [
    /class\s+(\w+)\s*:\s*public\s+Nan::ObjectWrap/g,
    "class $1 : public Napi::ObjectWrap<$1>"
  ],
  [
    /(\w+)\(([^\)]*)\)\s*:\s*Nan::ObjectWrap\(\)\s*(,)?/gm,
    "$1($2) : Napi::ObjectWrap<$1>()$3"
  ],
  ...
  [
    /\.As<v8::(Value|Boolean|String|Number|Object|Array|Symbol|External|Function)>\(\)/g,
    ".As<Napi::$1>()"
  ],
  [
    /\.As<(Value|Boolean|String|Number|Object|Array|Symbol|External|Function)>\(\)/g,
    ".As<Napi::$1>()"
  ],
  ...
  [
    /Nan::To<v8::(Boolean|String|Number|Object|Array|Symbol|Function)>\((.+?)\)/g,
    "$2.To<Napi::$1>()"
  ],
  [
    /Nan::To<(Boolean|String|Number|Object|Array|Symbol|Function)>\((.+?)\)/g,
    "$2.To<Napi::$1>()"
  ],
  ...
  [
    /([ ]*)return Nan::Throw(\w*?)Error\((.+?)\);/g,
    "$1Napi::$2Error::New(env, $3).ThrowAsJavaScriptException();\n$1return env.Null();"
  ],
  [
    /Nan::Throw(\w*?)Error\((.+?)\);\n(\s*)return;/g,
    "Napi::$1Error::New(env, $2).ThrowAsJavaScriptException();\n$3return env.Null();"
  ],
  [
    /Nan::Throw(\w*?)Error\((.+?)\);/g,
    "Napi::$1Error::New(env, $2).ThrowAsJavaScriptException();\n"
  ...
  [
    /\.ForceSet\(Napi::String::New\(env, "(\w+)"\),\s*?/g,
    '.DefineProperty("$1", '
  ],
  ...
  [
    /Nan::ADDON_REGISTER_FUNCTION_ARGS_TYPE target/g,
    "Napi::Env& env, Napi::Object& target"
  ],

  [
    /(\w+)\*\s+(\w+)\s*=\s*Nan::ObjectWrap::Unwrap<\w+>\(info\.This\(\)\);/g,
    "$1* $2 = this;"
  ],
  ...
  [
    /NAN_METHOD\(([\w\d:]+?)\)/g,
    "Napi::Value $1(const Napi::CallbackInfo& info)"
  ],
  [
    /static\s*NAN_GETTER\(([\w\d:]+?)\)/g,
    "Napi::Value $1(const Napi::CallbackInfo& info)"
  ],
  [
    /NAN_GETTER\(([\w\d:]+?)\)/g,
  ...
  [
    /static\s*NAN_SETTER\(([\w\d:]+?)\)/g,
    "void $1(const Napi::CallbackInfo& info, const Napi::Value& value)"
  ],
  [
    /NAN_SETTER\(([\w\d:]+?)\)/g,
    "void $1(const Napi::CallbackInfo& info, const Napi::Value& value)"
  ...
  [
    /NAN_MODULE_INIT\(([\w\d:]+?)\);/g,
    "Napi::Object $1(Napi::Env env, Napi::Object exports);"
  ],
  [
    /NAN_MODULE_INIT\(([\w\d:]+?)\)/g,
    "Napi::Object $1(Napi::Env env, Napi::Object exports)"
  ...
  [
    /Nan::FunctionCallbackInfo<(v8::)*Value>\s*&\s*info\);/g,
    "Napi::CallbackInfo& info);"
  ],
  ...
  [
    /v8::Local<v8::(Value|Boolean|String|Number|Object|Array|Symbol|External|Function)>/g,
    "Napi::$1"
  ],
  [
    /Local<(Value|Boolean|String|Number|Object|Array|Symbol|External|Function)>/g,
    "Napi::$1"
  ],
