...
The content still gets escaped properly, with the exception of the `script` and `style` tags. _Allowing either `script` or `style` leaves you open to XSS attacks. Don't do that_ unless you have good reason to trust their origin.
