      ...
      switch (token[0]) {
        case tokens.space:
          ...
          if (lastAdded) {
            ...
            _dotProp2.default.set(
              node,
              spaceProp,
              _dotProp2.default.get(node, spaceProp, "") + content
            );
        ...
        case tokens.word:
          if (
            ...
            this.content(next) === "|" &&
            attr[pos + 2] &&
            attr[pos + 2][0] !== tokens.equals && // this look-ahead probably fails with comment nodes involved.
            !node.operator &&
            !node.namespace
          ) {
            ...
            _dotProp2.default.set(
              node,
              "raws.unquoted",
              _dotProp2.default.get(node, "raws.unquoted", "") + content
            );
          } else if (content === "i") {
        ...
        case tokens.comment:
          if (lastAdded) {
            if (
              ...
              (next && next[0] === tokens.space)
            ) {
              var lastComment = _dotProp2.default.get(
                node,
                "raws.spaces." + lastAdded + ".after",
                _dotProp2.default.get(
                  node,
                  "spaces." + lastAdded + ".after",
                  ""
                )
              );
              _dotProp2.default.set(
              ...
              var lastValue = _dotProp2.default.get(
                node,
                "raws." + lastAdded,
                _dotProp2.default.get(node, lastAdded, "")
              );
              _dotProp2.default.set(
                node,
                "raws." + lastAdded,
    ...
    if (this.currToken[0] === tokens.word) {
      this.splitWord(false, function(first, length) {
        ...
        if (
          length > 1 &&
          _this2.nextToken &&
          _this2.nextToken[0] === tokens.openParenthesis
        ) {
