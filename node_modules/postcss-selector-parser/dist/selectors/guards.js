...
var isAttribute = (exports.isAttribute = isNodeType.bind(
  null,
  _types.ATTRIBUTE
));
var isClassName = (exports.isClassName = isNodeType.bind(null, _types.CLASS));
var isCombinator = (exports.isCombinator = isNodeType.bind(
  null,
  _types.COMBINATOR
));
...
var isUniversal = (exports.isUniversal = isNodeType.bind(
  null,
  _types.UNIVERSAL
));
