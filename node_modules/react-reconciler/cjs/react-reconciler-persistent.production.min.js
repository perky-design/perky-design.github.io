...
module.exports = function $$$reconciler($$$hostConfig) {
  ...
  function ed(a) {
    ...
    function h(b, a, c, d) {
      if (null !== a && a.elementType === c.type)
        return (d = e(a, c.props, d)), (d.ref = cd(b, a, c)), (d.return = b), d;
    ...
    function K(b, a, c, d, e) {
      ...
      if ("object" === typeof d && null !== d) {
        switch (d.$$typeof) {
          ...
          case da:
            return (
              (b = b.get(null === d.key ? c : d.key) || null), k(a, b, d, e)
            );
        }
    ...
    function Ha(e, g, h, l) {
      ...
      for (t = d(e, t); r < h.length; r++)
        (p = K(t, e, r, h[r], l)),
          null !== p &&
            (a && null !== p.alternate && t.delete(null === p.key ? r : p.key),
            (g = f(p, g, r)),
    ...
    function O(e, g, h, l) {
      ...
      for (r = d(e, r); !v.done; w++, v = h.next())
        (v = K(r, e, w, v.value, l)),
          null !== v &&
            (a && null !== v.alternate && r.delete(null === v.key ? w : v.key),
            (g = f(v, g, w)),
            null === t ? (k = v) : (t.sibling = v),
            (t = v));
      a &&
      ...
      if ("string" === typeof f || "number" === typeof f)
        return (
          ...
          null !== d && 6 === d.tag
            ...
            : (c(a, d), (d = gd(f, a.mode, h)), (d.return = a), (a = d)),
          g(a)
        );
    ...
    null === Dd
      ...
      : ((b = Dd.lastEffect),
        null === b
          ...
          : ((c = b.next), (b.next = a), (a.next = c), (Dd.lastEffect = a)));
    return a;
  }
  function Wd(a, b, c, d) {
    var e = Od();
  ...
  function ie(a, b) {
    switch (a.tag) {
      ...
      case 6:
        return (
          (b = pb(b, a.pendingProps)), null !== b ? ((a.stateNode = b), !0) : !1
        );
      case 13:
        return !1;
      default:
  ...
  function xe(a, b, c, d, e) {
    ...
    if (null === b.stateNode)
      ...
      l !== d || x !== h || B.current || Dc
        ? ("function" === typeof p && (Uc(b, c, p, d), (h = b.memoizedState)),
      ...
      (g = b.stateNode),
        ...
        l !== d || h !== x || B.current || Dc
          ? ("function" === typeof p && (Uc(b, c, p, d), (x = b.memoizedState)),
  ...
  function ye(a, b, c, d, e, f) {
    ...
    b.effectTag |= 1;
    null !== a && g
      ? ((b.child = kd(b, a.child, null, f)), (b.child = kd(b, null, l, f)))
      : Q(a, b, l, f);
      ...
      for (var e = b.child; null !== e; ) {
        if (5 === e.tag) {
          ...
          if (
            ...
            if (
              null !== g &&
              (null !== g.child && ((g.child.return = g), Ge(a, g, !0, f)),
              (f = g.sibling),
              null !== f)
            ) {
              f.return = e;
      ...
      for (var e = b.child; null !== e; ) {
        if (5 === e.tag) {
          ...
          if (
            ...
            if (
              null !== g &&
              (null !== g.child && ((g.child.return = g), Ke(a, g, !0, f)),
              (f = g.sibling),
              null !== f)
            ) {
              f.return = e;
      ...
      for (var e = a; ; ) {
        ...
        if (f)
          (f = f ? e.stateNode : e.stateNode.instance),
            c ? (d ? Za(b, f, c) : Ya(b, f, c)) : d ? Ua(b, f) : Ta(b, f);
  ...
  function mf(a, b, c) {
    ...
    null !== f &&
      ...
      (c.callback = function() {
        "function" !== typeof d &&
          (null === nf ? (nf = new Set([this])) : nf.add(this), Pe(a, b));
        var c = b.stack;
    ...
    if (0 !== a.lastExpiredTime)
      ...
      if (0 === b)
        ...
        b =
          1073741823 === b
            ? jc(Of.bind(null, a))
            : ic(d, Tf.bind(null, a), { timeout: 10 * (1073741821 - b) - E() });
        a.callbackNode = b;
      }
    }
  }
            ...
            case yf:
              if (1073741823 !== Af && null !== Cf) {
                ...
                0 >= d
                  ...
                  : ((e = g.busyDelayMs | 0),
                    (f =
                      E() - (10 * (1073741821 - f) - (g.timeoutMs | 0 || 5e3))),
                    (d = f <= e ? 0 : e + d - f));
                if (10 < d) {
                  Pf(a, c);
                  a.timeoutHandle = Ma(ag.bind(null, a), d);
          ...
          if (
            ...
            do {
              ...
              if (k) {
                ...
                var O = c.pingCache;
                null === O
                  ? ((O = c.pingCache = new hf()), (f = new Set()), O.set(g, f))
                  : ((f = O.get(g)),
      ...
      case 3:
        ...
        if (d === e) oe(), (b = re(a, b, c));
          ...
          if ((e = b.stateNode.hydrate))
            Sa
              ? ((ee = tb(b.stateNode.containerInfo)), (de = b), (e = fe = !0))
              : (e = !1);
          if (e)
