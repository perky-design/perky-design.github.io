...
function mapFilterValues(collection, iteratee, predicate) {
  ...
  try {
    for (
      var _b = __values(keys(collection)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var key = _c.value;
...
function pathsToStateValue(paths) {
  ...
  try {
    for (
      var paths_1 = __values(paths), paths_1_1 = paths_1.next();
      !paths_1_1.done;
...
function mapContext(mapper, context, _event) {
  ...
  try {
    for (
      var _b = __values(keys(mapper)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var key = _c.value;
  ...
  var updatedContext = context
    ? assignActions.reduce(function(acc, assignAction) {
        ...
        if (isFunction(assignment)) {
          ...
          try {
            for (
              var _b = __values(keys(assignment)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var key = _c.value;
