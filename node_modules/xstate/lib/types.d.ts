...
export declare type ActionFunction<TContext, TEvent extends EventObject> = (
  context: TContext,
  event: TEvent,
...
export declare type Action<TContext, TEvent extends EventObject> =
  | ActionType
...
export declare type ExtractStateValue<
...
export declare type ConditionPredicate<TContext, TEvent extends EventObject> = (
  context: TContext,
  event: TEvent,
...
export declare type Guard<TContext, TEvent extends EventObject> =
...
export declare type Condition<TContext, TEvent extends EventObject> =
  | string
  | ConditionPredicate<TContext, TEvent>
  | Guard<TContext, TEvent>;
export declare type TransitionTarget<
  TContext,
  TEvent extends EventObject
> = SingleOrArray<string | StateNode<TContext, any, TEvent>>;
export declare type TransitionTargets<TContext> = Array<
...
export declare type ConditionalTransitionConfig<
  TContext,
...
export declare type ActivityConfig<TContext, TEvent extends EventObject> = (
  ctx: TContext,
  activity: ActivityDefinition<TContext, TEvent>
) => DisposeActivityFunction | void;
export declare type Activity<TContext, TEvent extends EventObject> =
  | string
...
export declare type Receiver<TEvent extends EventObject> = (
  listener: (event: TEvent) => void
) => void;
export declare type InvokeCallback = (
  callback: Sender<any>,
 ...
 */
export declare type InvokeCreator<
  TContext,
...
export declare type DelayedTransitions<TContext, TEvent extends EventObject> =
  | Record<
      string | number,
  ...
  | Array<
    ...
    >;
export declare type StateTypes =
  | "atomic"
  | "compound"
  | "parallel"
  | "final"
...
export declare type StateNodesConfig<
  TContext,
...
export declare type StatesConfig<
  TContext,
  TStateSchema extends StateSchema,
  TEvent extends EventObject
> = {
...
export declare type StatesDefinition<
  TContext,
  TStateSchema extends StateSchema,
  TEvent extends EventObject
> = {
...
export declare type TransitionConfigTarget<
  TContext,
  TEvent extends EventObject
> = string | undefined | StateNode<TContext, any, TEvent>;
export declare type TransitionConfigOrTarget<
  TContext,
  TEvent extends EventObject
> = SingleOrArray<
...
declare type TransitionsConfigArray<
  TContext,
  TEvent extends EventObject
> = Array<
  | {
...
export declare type SimpleOrStateNodeConfig<
  TContext,
  TStateSchema extends StateSchema,
  TEvent extends EventObject
> =
...
export declare type ActionFunctionMap<
  TContext,
  TEvent extends EventObject
> = Record<
  string,
...
>;
export declare type DelayFunctionMap<
  TContext,
  TEvent extends EventObject
> = Record<string, DelayConfig<TContext, TEvent>>;
export declare type ServiceConfig<TContext> =
  | string
  | StateMachine<any, any, any>
  | InvokeCreator<TContext>;
export declare type DelayConfig<TContext, TEvent extends EventObject> =
  | number
...
export declare type DelayExpr<
  TContext,
  TEvent extends EventObject
> = ExprWithMeta<TContext, TEvent, number>;
export declare type LogExpr<
  TContext,
  TEvent extends EventObject
...
export declare type Expr<TContext, TEvent extends EventObject, T> = (
  context: TContext,
  event: TEvent
) => T;
export declare type ExprWithMeta<TContext, TEvent extends EventObject, T> = (
  context: TContext,
  event: TEvent,
  meta: SCXMLEventMeta<TEvent>
) => T;
export declare type SendExpr<
  TContext,
  TEvent extends EventObject,
  TSentEvent extends EventObject = AnyEventObject
...
export declare type Assigner<TContext, TEvent extends EventObject> = (
  context: TContext,
  event: TEvent,
...
export declare type Mapper<TContext, TEvent extends EventObject> = (
  context: TContext,
  event: TEvent
) => any;
export declare type PropertyMapper<
  TContext,
  TEvent extends EventObject
> = Partial<{
...
export declare type TransitionDefinitionMap<
  TContext,
  TEvent extends EventObject
> = {
