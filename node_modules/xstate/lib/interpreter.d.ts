...
export declare type StateListener<
  TContext,
...
export declare type ContextListener<TContext = DefaultContext> = (
  context: TContext,
  prevContext: TContext | undefined
) => void;
export declare type EventListener<TEvent extends EventObject = EventObject> = (
  event: TEvent
) => void;
...
> implements Actor<State<TContext, TEvent, TStateSchema, TTypestate>, TEvent> {
   ...
   */
  send: (
    event: TEvent | TEvent["type"] | Event<TEvent>[] | SCXML.Event<TEvent>,
...
export declare function spawn<TC, TE extends EventObject>(
