...
export declare function getEventType<TEvent extends EventObject = EventObject>(
  event: Event<TEvent>
): TEvent["type"];
export declare function getActionType(action: Action<any, any>): ActionType;
export declare function toStatePath(
  stateId: string | string[],
  delimiter: string
): string[];
export declare function isStateLike(state: any): state is StateLike<any>;
export declare function toStateValue(
...
export declare function mapFilterValues<T, P>(
  collection: {
    [key: string]: T;
  },
  iteratee: (
 ...
 */
export declare const path: <T extends Record<string, any>>(
  props: string[]
) => any;
/**
 ...
 * @param props The deep path to the prop of the desired value
 */
export declare function nestedPath<T extends Record<string, any>>(
  props: string[],
  accessorProp: keyof T
): (object: T) => T;
export declare function toStatePaths(
...
export declare function mapContext<TContext, TEvent extends EventObject>(
...
export declare function updateHistoryStates(
  hist: HistoryValue,
  stateValue: StateValue
): Record<string, HistoryValue | undefined>;
export declare function updateHistoryValue(
  hist: HistoryValue,
  stateValue: StateValue
): HistoryValue;
export declare function updateContext<TContext, TEvent extends EventObject>(
  context: TContext,
  _event: SCXML.Event<TEvent>,
...
export declare function toGuard<TContext, TEvent extends EventObject>(
...
export declare function isObservable<T>(
  value: Subscribable<T> | any
): value is Subscribable<T>;
export declare const symbolObservable: string | symbol;
export declare function isMachine(
  value: any
): value is StateMachine<any, any, any>;
export declare function isActor(value: any): value is Actor;
export declare const uniqueId: () => string;
export declare function toEventObject<TEvent extends EventObject>(
  event: Event<TEvent>,
  payload?: EventData
): TEvent;
export declare function toSCXMLEvent<TEvent extends EventObject>(
...
>;
export declare function normalizeTarget<TContext, TEvent extends EventObject>(
  target: SingleOrArray<string | StateNode<TContext, any, TEvent>> | undefined
): Array<string | StateNode<TContext, any, TEvent>> | undefined;
export declare function reportUnhandledExceptionOnInvocation(
  originalError: any,
  currentError: any,
  id: string
): void;
export declare function evaluateGuard<TContext, TEvent extends EventObject>(
