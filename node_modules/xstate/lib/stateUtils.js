...
function getChildren(stateNode) {
  return utils_1.keys(stateNode.states).map(function(key) {
...
function getAllStateNodes(stateNode) {
  ...
  return stateNodes.concat(
    utils_1.flatten(getChildren(stateNode).map(getAllStateNodes))
  );
}
