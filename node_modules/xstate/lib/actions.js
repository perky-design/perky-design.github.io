...
function resolveSend(action, ctx, _event, delaysMap) {
  ...
  var resolvedEvent = utils_1.toSCXMLEvent(
    utils_1.isFunction(action.event)
...
exports.log = log;
exports.resolveLog = function(action, ctx, _event) {
  return __assign(__assign({}, action), {
    value: utils_1.isString(action.expr)
      ? action.expr
...
function resolveActions(
  ...
  var _a = __read(
      utils_1.partition(actions, function(action) {
  ...
  var updatedContext = assignActions.length
    ...
    : currentContext;
  var resolvedActions = utils_1.flatten(
    otherActions.map(function(actionObject) {
      var _a;
      switch (actionObject.type) {
        ...
        case actionTypes.send:
          ...
          if (!environment_1.IS_PRODUCTION) {
            ...
            utils_1.warn(
              !utils_1.isString(actionObject.delay) ||
        ...
        case actionTypes.choose: {
          ...
          var resolved = resolveActions(
            machine,
            currentState,
            updatedContext,
            _event,
            exports.toActionObjects(
              utils_1.toArray(matchedActions),
