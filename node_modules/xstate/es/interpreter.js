...
var Interpreter =
  ...
  (function() {
    ...
    Interpreter.prototype.subscribe = function(
      nextListenerOrObserver, // @ts-ignore
      errorListener,
      completeListener
    ) {
      var _this = this;
      ...
      switch (action.type) {
        ...
        case start: {
          ...
          if (activity.type === ActionTypes.Invoke) {
            ...
            if (!IS_PRODUCTION) {
              warn(
                !("forward" in activity), // tslint:disable-next-line:max-line-length
...
var resolveSpawnOptions = function(nameOrOptions) {
  ...
  return __assign(
    __assign(__assign({}, DEFAULT_SPAWN_OPTIONS), {
      name: uniqueId()
    }),
    nameOrOptions
  );
