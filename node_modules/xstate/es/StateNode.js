  ...
  (function() {
    ...
    StateNode.prototype.getDelayedTransitions = function() {
      ...
      return delayedTransitions.map(function(delayedTransition) {
        ...
        return __assign(
          __assign({}, _this.formatTransition(delayedTransition)),
          {
            delay: delay
          }
        );
    ...
    StateNode.prototype.transitionLeafNode = function(
      stateValue,
      state,
      _event
    ) {
    ...
    StateNode.prototype.transitionParallelNode = function(
      ...
      try {
        for (
          var _b = __values(keys(stateValue)), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
      ...
      try {
        for (
          ...
          var isInState = stateIn
            ? isString(stateIn) && isStateId(stateIn) // Check if in state by ID
              ? state.matches(
                  toStateValue(
    ...
    StateNode.prototype.resolveTransition = function(
      ...
      var activities = currentState
        ? __assign({}, currentState.activities)
        : {};
      ...
      var _b = __read(
          resolveActions(this, currentState, currentContext, _event, actions),
          2
        ),
      ...
      var _c = __read(
          partition(resolvedActions, function(action) {
            return (
              action.type === raise$1 ||
              (action.type === send$1 && action.to === SpecialTargets.Internal)
            );
          }),
          2
        ),
    ...
    StateNode.prototype.resolve = function(stateValue) {
      ...
      switch (this.type) {
        case "parallel":
          return mapValues(this.initialStateValue, function(
            subStateValue,
            subStateKey
          ) {
    ...
    StateNode.prototype.resolveHistory = function(historyValue) {
      ...
      var subHistoryValue = nestedPath(parent.path, "states")(historyValue)
        .current;
    ...
    Object.defineProperty(StateNode.prototype, "events", {
      ...
      get: function() {
        ...
        if (states) {
          try {
            for (
              var _c = __values(keys(states)), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
    ...
    StateNode.prototype.resolveTarget = function(_target) {
      ...
      return _target.map(function(target) {
        ...
        if (_this.parent) {
          try {
            var targetStateNode = _this.parent.getStateNodeByPath(
              resolvedTarget
            );
      ...
      if (!this.config.on) {
        ...
        onConfig = flatten(
          keys(strictOnConfigs_1)
            .map(function(key) {
              var arrayified = toTransitionConfigArray(
                key,
