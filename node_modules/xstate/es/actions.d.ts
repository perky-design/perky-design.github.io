...
export declare function getActionFunction<TContext, TEvent extends EventObject>(
  ...
  | undefined;
export declare function toActionObject<TContext, TEvent extends EventObject>(
  action: Action<TContext, TEvent>,
  actionFunctionMap?: ActionFunctionMap<TContext, TEvent>
): ActionObject<TContext, TEvent>;
export declare const toActionObjects: <TContext, TEvent extends EventObject>(
  action?:
    | string
  ...
  actionFunctionMap?:
    | Record<
        string,
        ActionFunction<TContext, TEvent> | ActionObject<TContext, TEvent>
      >
    | undefined
) => ActionObject<TContext, TEvent>[];
export declare function toActivityDefinition<
  TContext,
 ...
 */
export declare function raise<TContext, TEvent extends EventObject>(
  event: Event<TEvent>
): RaiseAction<TEvent> | SendAction<TContext, TEvent, TEvent>;
export declare function resolveRaise<TEvent extends EventObject>(
...
export declare function resolveSend<
  TContext,
  TEvent extends EventObject,
 ...
 * @param options Options to pass into the send event.
 */
export declare function sendParent<
  TContext,
  TEvent extends EventObject,
  TSentEvent extends EventObject = AnyEventObject
>(
 ...
 */
export declare function sendUpdate<
  TContext,
  TEvent extends EventObject
>(): SendAction<
  TContext,
 ...
 */
export declare function log<TContext, TEvent extends EventObject>(
  expr?: string | LogExpr<TContext, TEvent>,
  label?: string
): LogAction<TContext, TEvent>;
export declare const resolveLog: <TContext, TEvent extends EventObject>(
 ...
 */
export declare function start<TContext, TEvent extends EventObject>(
...
export declare function isActionObject<TContext, TEvent extends EventObject>(
  action: Action<TContext, TEvent>
...
export declare function pure<TContext, TEvent extends EventObject>(
  getActions: (
    context: TContext,
    event: TEvent
 ...
 */
export declare function forwardTo<TContext, TEvent extends EventObject>(
 ...
 * @param options Options to pass into the send action creator.
 */
export declare function escalate<
  TContext,
  TEvent extends EventObject,
  TErrorData = any
>(
...
export declare function choose<TContext, TEvent extends EventObject>(
  conds: Array<ChooseConditon<TContext, TEvent>>
): ChooseAction<TContext, TEvent>;
export declare function resolveActions<TContext, TEvent extends EventObject>(
