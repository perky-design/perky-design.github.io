!(function(t, e) {
  ...
  function c(t, e, n) {
    ...
    return N(r)
      ...
      : s(i).every(function(t) {
          return t in r && c(i[t], r[t]);
        });
  }
  function u(t) {
    try {
      return N(t) || "number" == typeof t ? "" + t : t.type;
    } catch (t) {
      throw new Error(
  ...
  function h(t, e) {
    try {
      return E(t) ? t : t.toString().split(e);
    } catch (e) {
  ...
  function d(t, e) {
    for (var n = {}, i = s(t), r = 0; r < i.length; r++) {
      var o = i[r];
      n[o] = e(t[o], o, t, r);
    }
    return n;
  ...
  function v(t, e, n) {
    var r,
      ...
      a = {};
    try {
      for (var c = i(s(t)), u = c.next(); !u.done; u = c.next()) {
        var h = u.value,
          f = t[h];
        n(f) && (a[h] = e(f, h, t));
      }
  ...
  function w(t) {
    return (
      ...
      !(null === t || (!T(t) && "object" != typeof t) || !T(t.then))
    );
  }
  function b(t, e) {
    var n,
      ...
      c = a[1];
    try {
      for (var u = i(t), h = u.next(); !h.done; h = u.next()) {
        var f = h.value;
  ...
  function _(t, e) {
    return d(t.states, function(t, n) {
      if (t) {
        var i = (N(e) ? void 0 : e[n]) || (t ? t.current : void 0);
        if (i) return { current: i, states: _(t, i) };
      }
    });
  }
  function E(t) {
  ...
  function L(t, n) {
    return N(t) || "number" == typeof t ? e({ type: t }, n) : t;
  }
  function M(t, n) {
    if (!N(t) && "$$type" in t && "scxml" === t.$$type) return t;
    var i = L(t);
    return e({ name: i.type, data: i, $$type: "scxml", type: "external" }, n);
  }
  function R(t, n) {
  ...
  function D(t, e, n, i, r) {
    ...
    if ("xstate.guard" === e.type) return e.predicate(n, i.data, a);
    var s = o[e.type];
    if (!s)
      throw new Error(
  ...
  ((C = t.ActionTypes || (t.ActionTypes = {})).Start = "xstate.start"),
    (C.Stop = "xstate.stop"),
    (C.Raise = "xstate.raise"),
    (C.Send = "xstate.send"),
    (C.Cancel = "xstate.cancel"),
    (C.NullEvent = ""),
    (C.Assign = "xstate.assign"),
    (C.After = "xstate.after"),
    (C.DoneState = "done.state"),
    (C.DoneInvoke = "done.invoke"),
    (C.Log = "xstate.log"),
    (C.Init = "xstate.init"),
    (C.Invoke = "xstate.invoke"),
    (C.ErrorExecution = "error.execution"),
    (C.ErrorCommunication = "error.communication"),
    (C.ErrorPlatform = "error.platform"),
    (C.ErrorCustom = "xstate.error"),
    (C.Update = "xstate.update"),
    (C.Pure = "xstate.pure"),
    (C.Choose = "xstate.choose"),
  ...
  function z(t) {
    var e = [t];
    return F(t) ? e : e.concat(g(U(t).map(z)));
  }
  function J(t, e) {
    var n,
      r,
      ...
      l = new Set(e);
    try {
      for (var d = i(l), v = d.next(); !v.done; v = d.next())
        for (var p = (E = v.value).parent; p && !l.has(p); )
          l.add(p), (p = p.parent);
    } catch (t) {
      n = { error: t };
    } finally {
    ...
    var y = B(l);
    try {
      for (var g = i(l), m = g.next(); !m.done; m = g.next()) {
        if (
    ...
    try {
      for (var b = i(l), _ = b.next(); !_.done; _ = b.next()) {
        var E;
        for (p = (E = _.value).parent; p && !l.has(p); )
          l.add(p), (p = p.parent);
      }
    } catch (t) {
      u = { error: t };
  ...
  var H = t.ActionTypes.Start,
    G = t.ActionTypes.Stop,
    K = t.ActionTypes.Raise,
    Q = t.ActionTypes.Send,
    W = t.ActionTypes.Cancel,
    Y = t.ActionTypes.NullEvent,
    Z = t.ActionTypes.Assign,
    tt = (t.ActionTypes.After, t.ActionTypes.DoneState, t.ActionTypes.Log),
    et = t.ActionTypes.Init,
    nt = t.ActionTypes.Invoke,
    it = (t.ActionTypes.ErrorExecution, t.ActionTypes.ErrorPlatform),
    rt = t.ActionTypes.ErrorCustom,
    ot = t.ActionTypes.Update,
    at = t.ActionTypes.Choose,
    st = t.ActionTypes.Pure,
    ct = M({ type: et });
  function ut(t, e) {
    return (e && e[t]) || void 0;
  }
  function ht(t, i) {
    var r;
    if (N(t) || "number" == typeof t) {
      var o = ut(t, i);
      r = T(o) ? { type: t, exec: o } : o || { type: t, exec: void 0 };
    } else if (T(t)) r = { type: t.name || t.toString(), exec: t };
    else {
      if (T((o = ut(t.type, i)))) r = e(e({}, t), { exec: o });
      else if (o) {
        var a = t.type,
          s = n(t, ["type"]);
        r = e(e({ type: a }, o), s);
  ...
  function lt(t) {
    var n = ht(t);
    return e(e({ id: N(t) ? t : n.id }, n), { type: n.type });
  }
  function dt(e) {
    return N(e)
      ? { type: K, event: e }
  ...
  function vt(t, e) {
    return {
      ...
      id: e && void 0 !== e.id ? e.id : T(t) ? t.name : u(t)
    };
  }
  function pt(n, i) {
    return vt(n, e(e({}, i), { to: t.SpecialTargets.Parent }));
  }
  function yt() {
    return pt(ot);
  }
  ...
  var wt = function(t) {
    return { type: Z, assignment: t };
  };
  function bt(e, n) {
    var i = n ? "#" + n : "";
    return t.ActionTypes.After + "(" + e + ")" + i;
  }
  function _t(e, n) {
    var i = t.ActionTypes.DoneState + "." + e,
      r = {
        type: i,
        data: n,
        toString: function() {
  ...
  function Et(e, n) {
    var i = t.ActionTypes.DoneInvoke + "." + e,
      r = {
        type: i,
        data: n,
        toString: function() {
  ...
  function Tt(e, n) {
    var i = t.ActionTypes.ErrorPlatform + "." + e,
      r = {
        type: i,
        data: n,
        toString: function() {
            ...
            return t
              ? n.reduce(function(t, n) {
                  var o,
                    ...
                    h = {};
                  if (T(c)) h = c(t, e.data, u);
                  else
                    try {
                      for (
                        var f = i(s(c)), l = f.next();
                        !l.done;
                        l = f.next()
                      ) {
                        var d = l.value,
                          v = c[d];
                        h[d] = T(v) ? v(t, e.data, u) : v;
                      }
                    } catch (t) {
                      o = { error: t };
                    } finally {
    ...
    return [
      g(
        f.map(function(i) {
          ...
          switch (i.type) {
            case K:
              return { type: K, _event: M(i.event) };
            case Q:
              return (function(t, n, i, r) {
                var o,
                  a = { _event: i },
                  s = M(T(t.event) ? t.event(n, i.data, a) : t.event);
                if (N(t.delay)) {
                  var c = r && r[t.delay];
                  o = T(c) ? c(n, i.data, a) : c;
                } else o = T(t.delay) ? t.delay(n, i.data, a) : t.delay;
                var u = T(t.to) ? t.to(n, i.data, a) : t.to;
                return e(e({}, t), {
                  to: u,
                  _event: s,
                  event: s.data,
              ...
              })(i, l, a, t.options.delays);
            case tt:
              return (function(t, n, i) {
                return e(e({}, t), {
                  value: N(t.expr) ? t.expr : t.expr(n, i.data, { _event: i })
                });
              })(i, l, a);
            case at:
              if (
                !(s =
                  null ===
                    (r = i.conds.find(function(e) {
                      var i = O(e.cond, t.options.guards);
                      return !i || D(t, i, l, a, n);
                    })) || void 0 === r
                    ? void 0
                    : r.actions)
              )
                return [];
              var o = Ot(t, n, l, a, ft(x(s), t.options.actions));
              return (l = o[1]), o[0];
            case st:
              var s;
              if (!(s = i.get(l, a.data))) return [];
              o = Ot(t, n, l, a, ft(x(s), t.options.actions));
              return (l = o[1]), o[0];
            default:
              return ht(i, t.options.actions);
          }
        })
      ),
      l
  ...
  var Pt = (function() {
    ...
    return (
      ...
      (t.prototype.toStrings = function(t, e) {
        var n = this;
        if ((void 0 === t && (t = this.value), void 0 === e && (e = "."), N(t)))
          return [t];
        var i = s(t);
      ...
      (t.prototype.toJSON = function() {
        ...
        return n(this, ["configuration", "transitions"]);
      }),
    ...
    Ct = (function() {
      function a(t, n, r) {
        ...
        (this.config = t),
          ...
          (this.id =
            this.config.id ||
            o([this.machine.key], this.path).join(this.delimiter)),
          ...
          (this.states = this.config.states
            ? d(this.config.states, function(t, n) {
                var i,
                  r = new a(t, { _parent: c, _key: n });
                return (
                  Object.assign(c.idMap, e((((i = {})[r.id] = r), i), r.idMap)),
                  r
                );
              })
            : kt);
        ...
        !(function t(e) {
          ...
          e.order = u++;
          try {
            for (var o = i(U(e)), a = o.next(); !a.done; a = o.next()) {
              t(a.value);
            }
          } catch (t) {
            n = { error: t };
          ...
          (this.onEntry = x(this.config.entry || this.config.onEntry).map(
            function(t) {
              return ht(t);
            }
          )),
          (this.onExit = x(this.config.exit || this.config.onExit).map(function(
            t
          ) {
            return ht(t);
          })),
          ...
          (this.invoke = x(this.config.invoke).map(function(t, n) {
            var i, r;
            if (k(t))
              return (
                (c.machine.options.services = e(
                  (((i = {})[t.id] = t), i),
                  c.machine.options.services
                )),
                { type: nt, src: t.id, id: t.id }
              );
            if ("string" != typeof t.src) {
              var o = c.id + ":invocation[" + n + "]";
              return (
                (c.machine.options.services = e(
                  (((r = {})[o] = t.src), r),
                  c.machine.options.services
                )),
                e(e({ type: nt, id: o }, t), { src: o })
              );
            }
            return e(e({}, t), { type: nt, id: t.id || t.src, src: t.src });
          })),
      ...
      return (
        ...
        (a.prototype.getDelayedTransitions = function() {
          ...
          if (!n) return [];
          var i = function(e, n) {
            var i = bt(T(e) ? t.id + ":delay[" + n + "]" : e, t.id);
            return t.onEntry.push(vt(i, { delay: e })), t.onExit.push(mt(i)), i;
          };
          return (E(n)
            ? n.map(function(t, n) {
                var r = i(t.delay, n);
                return e(e({}, t), { event: r });
              })
            : g(
                s(n).map(function(t, r) {
                  var o = n[t],
                    a = N(o) ? { target: o } : o,
                    s = isNaN(+t) ? t : +t,
                    c = i(s, r);
                  return x(a).map(function(t) {
                    return e(e({}, t), { event: c, delay: s });
                  });
                })
              )
          ).map(function(n) {
            var i = n.delay;
            return e(e({}, t.formatTransition(n)), { delay: i });
          });
        }),
        (a.prototype.getStateNodes = function(t) {
          var e,
            n = this;
          if (!t) return [];
          var i = t instanceof Pt ? t.value : f(t, this.delimiter);
          if (N(i)) {
            var r = this.getStateNode(i).initial;
            return void 0 !== r
              ? this.getStateNodes((((e = {})[i] = r), e))
              : [this.states[i]];
          }
          var o = s(i);
          return o
        ...
        (a.prototype.resolveState = function(t) {
          ...
          return new Pt(
            e(e({}, t), { value: this.resolve(t.value), configuration: n })
          );
        }),
        ...
        (a.prototype.next = function(t, e) {
          ...
          try {
            for (
              var d = i(this.getCandidates(u)), v = d.next();
              !v.done;
              v = d.next()
            ) {
              var y = v.value,
                ...
                w =
                  ...
                  (N(x) && Vt(x)
                    ? t.matches(
                        f(this.getStateNodeById(x).path, this.delimiter)
                      )
                    : c(
                        f(x, this.delimiter),
                        p(this.path.slice(0, -2))(t.value)
                      )),
                b = !1;
              try {
                b = !m || D(this.machine, m, S, e, t);
              } catch (t) {
                throw new Error(
        ...
        (a.prototype.getActions = function(t, e, n, a) {
          ...
          try {
            for (var p = i(f), y = p.next(); !y.done; y = p.next()) {
              var m;
              ($(l, (m = y.value)) && !$(t.exitSet, m.parent)) ||
                t.exitSet.push(m);
            }
          } catch (t) {
            u = { error: t };
          ...
          var x = g(
            t.entrySet.map(function(i) {
              ...
              r.push(
                _t(i.id, i.data),
                _t(o.id, i.data ? S(i.data, e, n) : void 0)
              );
              var a = o.parent;
              return (
                "parallel" === a.type &&
                  U(a).every(function(e) {
                    return X(t.configuration, e);
                  }) &&
                  r.push(_t(a.id, a.data)),
                r
              );
            })
          );
        ...
        (a.prototype.transition = function(t, e, n) {
          ...
          var i,
            ...
            a = M(e);
          if (t instanceof Pt)
            i = void 0 === n ? t : this.resolveState(Pt.from(t, n));
          else {
            var s = N(t)
                ? this.resolve(l(this.getResolvedPath(t)))
                : this.resolve(t),
              c = n || this.machine.context;
            i = this.resolveState(Pt.from(s, c));
          }
          if (
            this.strict &&
            !this.events.includes(a.name) &&
            ((r = a.name), !/^(done|error)\./.test(r))
          )
            throw new Error(
              "Machine '" + this.id + "' does not accept event '" + a.name + "'"
            );
          var u = this._transition(i.value, i, a) || {
              transitions: [],
              configuration: [],
              entrySet: [],
              exitSet: [],
            ...
            h = J([], this.getStateNodes(i.value)),
            f = u.configuration.length ? J(h, u.configuration) : h;
          return (u.configuration = o(f)), this.resolveTransition(u, i, a);
        }),
        (a.prototype.resolveRaisedTransition = function(t, e, n) {
          ...
          return (
            ...
            (t.event = n.data),
            (i = t.actions).unshift.apply(i, o(r)),
            t
          );
        }),
        (a.prototype.resolveTransition = function(n, o, a, c) {
          var u, h;
          void 0 === a && (a = ct), void 0 === c && (c = this.machine.context);
          var f = n.configuration,
            l = !o || n.transitions.length > 0 ? q(this.machine, f) : void 0,
            d = o
              ? o.historyValue
                ? o.historyValue
                : n.source
              ...
              : void 0,
            v = o ? o.context : c,
            p = this.getActions(n, v, a, o),
            y = o ? e({}, o.activities) : {};
          try {
            for (var g = i(p), m = g.next(); !m.done; m = g.next()) {
              var x = m.value;
              x.type === H
                ? (y[x.activity.id || x.activity.type] = x)
                : x.type === G && (y[x.activity.id || x.activity.type] = !1);
            }
          } catch (t) {
            u = { error: t };
          } finally {
          ...
          var S,
            ...
            P = r(
              b(T, function(e) {
                return (
                  e.type === K ||
                  (e.type === Q && e.to === t.SpecialTargets.Internal)
                );
              }),
              2
            ),
            ...
            V = T.filter(function(t) {
              return t.type === H && t.activity.type === nt;
            }).reduce(
              function(t, e) {
                var n, i, r;
                return (
            ...
            C = l ? n.configuration : o ? o.configuration : [],
            j = C.reduce(function(t, e) {
            ...
            L = new Pt({
              ...
              historyValue: l
                ? d
                  ? ((S = d), (w = l), { current: w, states: _(S, w) })
                  : void 0
                : o
                ? o.historyValue
                : void 0,
              history: !l || n.source ? o : void 0,
              actions: l ? k : [],
              activities: l ? y : o ? o.activities : {},
              meta: l ? j : o ? o.meta : void 0,
              events: [],
              configuration: C,
            ...
            M = v !== O;
          L.changed = a.name === ot || M;
          var R = L.history;
          if ((R && delete R.history, !l)) return L;
          var D = L;
          if (!I)
            for (
              (this._transient ||
              ...
              (D = this.resolveRaisedTransition(D, { type: Y }, a));
              A.length;

            ) {
              var F = A.shift();
              D = this.resolveRaisedTransition(D, F._event, a);
            }
          var U =
            D.changed ||
            (R
              ? !!D.actions.length ||
                M ||
                typeof R.value != typeof D.value ||
                !(function t(e, n) {
                  if (e === n) return !0;
                  if (void 0 === e || void 0 === n) return !1;
                  if (N(e) || N(n)) return e === n;
                  var i = s(e),
                    r = s(n);
                  return (
                    i.length === r.length &&
          ...
          return (
            (D.changed = U),
            (D.historyValue = L.historyValue),
            (D.history = R),
            D
          );
        }),
        (a.prototype.getStateNode = function(t) {
          if (Vt(t)) return this.machine.getStateNodeById(t);
          if (!this.states)
            throw new Error(
        ...
        (a.prototype.resolve = function(t) {
          var e,
            n = this;
          if (!t) return this.initialStateValue || kt;
          switch (this.type) {
            case "parallel":
              return d(this.initialStateValue, function(e, i) {
                return e ? n.getStateNode(i).resolve(t[i] || e) : kt;
              });
            case "compound":
              if (N(t)) {
              ...
              return s(t).length
                ? d(t, function(t, e) {
                    return t ? n.getStateNode(e).resolve(t) : kt;
                  })
        ...
        Object.defineProperty(a.prototype, "events", {
          get: function() {
            ...
            if (o)
              try {
                for (var c = i(s(o)), u = c.next(); !u.done; u = c.next()) {
                  var h = o[u.value];
                  if (h.states)
                    try {
                      for (
                        var f = ((n = void 0), i(h.events)), l = f.next();
                        !l.done;
                        l = f.next()
                      ) {
                        var d = l.value;
        ...
        (a.prototype.formatTransitions = function() {
          ...
          var l = this.config.onDone
              ? R(String(_t(this.id)), this.config.onDone)
              : [],
            d = g(
              this.invoke.map(function(t) {
                var e = [];
                return (
                  t.onDone && e.push.apply(e, o(R(String(Et(t.id)), t.onDone))),
                  t.onError &&
                    e.push.apply(e, o(R(String(Tt(t.id)), t.onError))),
                  e
                );
              })
            ),
            v = this.after,
            p = g(
              o(l, d, r).map(function(t) {
                return x(t).map(function(t) {
                  return a.formatTransition(t);
                });
              })
            );
          try {
            for (var y = i(v), m = y.next(); !m.done; m = y.next()) {
              var S = m.value;
              p.push(S);
            }
          } catch (e) {
  ...
  var jt,
    ...
    Bt = { sync: !1, autoForward: !1 },
    qt =
      ((jt = []),
      function(t, e) {
        t && jt.push(t);
        var n = e(t || jt[jt.length - 1]);
        return t && jt.pop(), n;
      });
  !(function(t) {
  ...
  var $t = (function() {
    function n(i, r) {
      var o = this;
      void 0 === r && (r = n.defaultOptions),
        (this.machine = i),
        (this.scheduler = new Mt()),
        ...
        (this.initialized = !1),
        (this._status = It.NotStarted),
        (this.children = new Map()),
        (this.forwardTo = new Set()),
        (this.init = this.start),
        (this.send = function(t, e) {
          if (E(t)) return o.batch(t), o.state;
          var n = M(L(t, e));
          if (o._status === It.Stopped) return o.state;
          if (o._status === It.NotStarted && o.options.deferEvents);
          else if (o._status !== It.Running)
            throw new Error(
              'Event "' +
                n.name +
        ...
        (this.sendTo = function(n, i) {
          var r =
              o.parent && (i === t.SpecialTargets.Parent || o.parent.id === i),
            a = r ? o.parent : At(i) ? i : o.children.get(i) || zt(i);
          if (a)
            "machine" in a
              ? a.send(
                  e(e({}, n), {
                    name: n.name === rt ? "" + Tt(o.id) : n.name,
                    origin: o.sessionId
                  })
                )
              : a.send(n.data);
      ...
      (this.id = f),
        ...
        (this.parent = u),
        (this.options = a),
        (this.scheduler = new Mt({ deferEvents: this.options.deferEvents })),
        (this.sessionId = Ft());
    }
    return (
      ...
      (n.prototype.execute = function(t, e) {
        var n, r;
        try {
          for (var o = i(t.actions), a = o.next(); !a.done; a = o.next()) {
            var s = a.value;
            this.exec(s, t, e);
          }
        } catch (t) {
      ...
      (n.prototype.update = function(t, e) {
        ...
        if (
          ...
          try {
            for (
              var l = i(this.eventListeners), d = l.next();
              !d.done;
              d = l.next()
            ) {
              (0, d.value)(t.event);
        ...
        try {
          for (var v = i(this.listeners), p = v.next(); !p.done; p = v.next()) {
            (0, p.value)(t, t.event);
          }
        } catch (t) {
          o = { error: t };
        ...
        try {
          for (
            var y = i(this.contextListeners), g = y.next();
            !g.done;
            g = y.next()
          ) {
            (0, g.value)(
        ...
        var m = X(t.configuration || [], this.machine);
        if (this.state.configuration && m) {
          var x = t.configuration.find(function(t) {
              return "final" === t.type && t.parent === f.machine;
            }),
            w = x && x.data ? S(x.data, t.context, e) : void 0;
          try {
            for (
              var b = i(this.doneListeners), _ = b.next();
              !_.done;
              _ = b.next()
            ) {
              (0, _.value)(Et(this.id, w));
            }
          } catch (t) {
            u = { error: t };
          } finally {
      ...
      (n.prototype.onTransition = function(t) {
        return (
          ...
          this._status === It.Running && t(this.state, this.state.event),
          this
        );
      }),
      (n.prototype.subscribe = function(t, e, n) {
        ...
        return (
          "function" == typeof t
            ? (i = t)
            : ((i = t.next.bind(t)), (o = t.complete.bind(t))),
          this.listeners.add(i),
          this._status === It.Running && i(this.state),
          o && this.onDone(o),
          {
      ...
      (n.prototype.start = function(t) {
        var e = this;
        if (this._status === It.Running) return this;
        Ut(this.sessionId, this),
          (this.initialized = !0),
          (this._status = It.Running);
        var n =
          void 0 === t
            ? this.initialState
            : qt(this, function() {
                return !N((n = t)) && "value" in n && "history" in n
                  ? e.machine.resolveState(t)
                  : e.machine.resolveState(Pt.from(t, e.machine.context));
                var n;
              });
        return (
      ...
      (n.prototype.stop = function() {
        var t, e, n, r, o, a, c, u, h, f;
        try {
          for (var l = i(this.listeners), d = l.next(); !d.done; d = l.next()) {
            var v = d.value;
        ...
        try {
          for (
            var p = i(this.stopListeners), y = p.next();
            !y.done;
            y = p.next()
          ) {
        ...
        try {
          for (
            var g = i(this.contextListeners), m = g.next();
            !m.done;
            m = g.next()
          ) {
            v = m.value;
        ...
        try {
          for (
            var x = i(this.doneListeners), S = x.next();
            !S.done;
            S = x.next()
          ) {
            v = S.value;
        ...
        try {
          for (
            var w = i(s(this.delayedEventsMap)), b = w.next();
            !b.done;
            b = w.next()
          ) {
            var _ = b.value;
      ...
      (n.prototype.batch = function(t) {
        var n = this;
        if (this._status === It.NotStarted && this.options.deferEvents);
        else if (this._status !== It.Running)
          throw new Error(
            t.length +
        ...
        this.scheduler.schedule(function() {
          var r,
            ...
            h = function(t) {
              ...
              n.forward(i),
                (s = qt(n, function() {
                  return n.machine.transition(s, i);
                })),
                u.push.apply(
                  u,
                  o(
          ...
          try {
            for (var f = i(t), l = f.next(); !l.done; l = f.next()) {
              h(l.value);
            }
          } catch (t) {
            r = { error: t };
          ...
          (s.changed = c), (s.actions = u), n.update(s, M(t[t.length - 1]));
        });
      }),
      ...
      (n.prototype.forward = function(t) {
        var e, n;
        try {
          for (var r = i(this.forwardTo), o = r.next(); !o.done; o = r.next()) {
            var a = o.value,
      ...
      (n.prototype.exec = function(e, n, i) {
        void 0 === i && (i = this.machine.options.actions);
        var r = n.context,
          o = n._event,
          a = e.exec || ut(e.type, i),
          s = T(a) ? a : a ? a.exec : e.exec;
        if (s)
          try {
            return s(r, o.data, { action: e, state: this.state, _event: o });
          } catch (t) {
            throw (this.parent &&
        ...
        switch (e.type) {
          ...
          case H:
            ...
            if (u.type === t.ActionTypes.Invoke) {
              var h = this.machine.options.services
                  ? this.machine.options.services[u.src]
                  : void 0,
                f = u.id,
                l = u.data,
                d = "autoForward" in u ? u.autoForward : !!u.forward;
              if (!h) return;
              var v = T(h) ? h(r, o.data) : h;
              w(v)
                ? (this.state.children[f] = this.spawnPromise(
                    Promise.resolve(v),
                    f
                  ))
                : T(v)
                ? (this.state.children[f] = this.spawnCallback(v, f))
                : P(v)
                ? (this.state.children[f] = this.spawnObservable(v, f))
                : k(v) &&
                  (this.state.children[f] = this.spawnMachine(
                    l ? v.withContext(S(l, r, o)) : v,
                    { id: f, autoForward: d }
                  ));
          ...
          case tt:
            var p = e.label,
              y = e.value;
            p ? this.logger(p, y) : this.logger(y);
        }
      }),
      ...
      (n.prototype.stopChild = function(t) {
        ...
        e && (this.removeChild(t), T(e.stop) && e.stop());
      }),
      (n.prototype.spawn = function(t, n, i) {
        if (w(t)) return this.spawnPromise(Promise.resolve(t), n);
        if (T(t)) return this.spawnCallback(t, n);
        if (At(t)) return this.spawnActor(t);
        if (P(t)) return this.spawnObservable(t, n);
        if (k(t)) return this.spawnMachine(t, e(e({}, i), { id: n }));
        throw new Error(
          'Unable to spawn entity "' + n + '" of type "' + typeof t + '".'
        );
      }),
      (n.prototype.spawnMachine = function(t, i) {
        var r = this;
        void 0 === i && (i = {});
        var o = new n(
            t,
      ...
      (n.prototype.spawnPromise = function(t, e) {
        ...
        t.then(
          function(t) {
            i || (n.removeChild(e), n.send(M(Et(e, t), { origin: e })));
          },
          function(t) {
            if (!i) {
              n.removeChild(e);
      ...
      (n.prototype.spawnCallback = function(t, e) {
        ...
        if (w(n)) return this.spawnPromise(n, e);
        var s = {
          id: e,
          send: function(t) {
      ...
      (n.prototype.spawnObservable = function(t, e) {
        var n = this,
          i = t.subscribe(
            ...
            function(t) {
              n.removeChild(e), n.send(M(Tt(e, t), { origin: e }));
            },
            function() {
              n.removeChild(e), n.send(M(Et(e), { origin: e }));
            }
          ),
          r = {
            id: e,
      ...
      (n.prototype.spawnActor = function(t) {
        ...
        if (
          ...
          (this.devTools = window.__REDUX_DEVTOOLS_EXTENSION__.connect(
            e(
              ...
              { features: e({ jump: !1, skip: !1 }, t ? t.features : void 0) }
            ),
            this.machine
          )),
  ...
  var Ht = {
    ...
    sendUpdate: yt,
    log: function(t, e) {
      return void 0 === t && (t = gt), { type: tt, label: e, expr: t };
    },
    cancel: mt,
    start: xt,
    stop: St,
    ...
    forwardTo: Nt,
    escalate: function(n, i) {
      return pt(function(t, e, i) {
        return { type: rt, data: T(n) ? n(t, e, i) : n };
      }, e(e({}, i), { to: t.SpecialTargets.Parent }));
    },
    choose: function(e) {
  ...
  (t.Interpreter = $t),
    ...
    (t.mapState = function(t, e) {
      var n, r, o;
      try {
        for (var a = i(s(t)), u = a.next(); !u.done; u = a.next()) {
          var h = u.value;
    ...
    (t.matchState = function(t, e, n) {
      ...
      try {
        for (var c = i(e), u = c.next(); !u.done; u = c.next()) {
          var h = r(u.value, 2),
            f = h[0],
            l = h[1];
    ...
    (t.spawn = function(t, n) {
      ...
      return qt(void 0, function(e) {
        return e
          ? e.spawn(t, i.name, i)
          : (void 0 === (n = i.name) && (n = "null"),
            {
              id: n,
              send: function() {},
              subscribe: function() {
