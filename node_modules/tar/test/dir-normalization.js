...
var expectEntries = [
  { path: "fixtures/", mode: "755", type: "5", linkpath: "" },
  { path: "fixtures/a/", mode: "755", type: "5", linkpath: "" },
  {
  ...
  { path: "fixtures/a/b/", mode: "755", type: "5", linkpath: "" },
  { path: "fixtures/a/x", mode: "644", type: "0", linkpath: "" },
  { path: "fixtures/a/b/c/", mode: "755", type: "5", linkpath: "" },
  { path: "fixtures/a/b/c/y", mode: "755", type: "2", linkpath: "../../x" }
];

var ef = 0;
var expectFiles = [
  { path: "", mode: "40755", type: "Directory", depth: 0, linkpath: undefined },
  {
    path: "/fixtures",
    mode: "40755",
    type: "Directory",
...
test("extract test", function(t) {
  ...
  extract.on("end", function() {
    t.equal(
      ee,
      expectEntries.length,
      "should see " + expectEntries.length + " entries"
    );
  ...
  extract.on("entry", function(entry) {
    ...
    t.equivalent(
      found,
      wanted,
      "tar entry " + ee + " " + (wanted && wanted.path)
    );
  });
  ...
  function next() {
    ...
    function foundEntry(entry) {
      ...
      t.equivalent(
        found,
        wanted,
        "unpacked file " + ef + " " + (wanted && wanted.path)
      );
