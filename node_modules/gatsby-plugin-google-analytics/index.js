...
var createFunctionWithTimeout = function createFunctionWithTimeout(
  callback,
  opt_timeout
) {
...
function trackCustomEvent(_ref) {
  var category = _ref.category,
    ...
    nonInteraction =
      _ref$nonInteraction === void 0 ? false : _ref$nonInteraction,
    transport = _ref.transport,
    hitCallback = _ref.hitCallback,
    _ref$callbackTimeout = _ref.callbackTimeout,
    callbackTimeout =
      _ref$callbackTimeout === void 0 ? 1000 : _ref$callbackTimeout;
