...
function _generateIcon() {
  _generateIcon = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee4(icon, srcIcon) {
        ...
        function _callee5$(_context5) {
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              case 0:
                cacheKey = (0, _gatsbyCoreUtils.createContentDigest)(
...
exports.onPreInit = function(_, pluginOptions) {
  var _pluginOptions$cache_,
    _pluginOptions$includ,
    _pluginOptions$legacy,
    _pluginOptions$theme_;

  pluginOptions.cache_busting_mode =
    (_pluginOptions$cache_ = pluginOptions.cache_busting_mode) !== null &&
    _pluginOptions$cache_ !== void 0
      ? _pluginOptions$cache_
      : "query";
  pluginOptions.include_favicon =
    (_pluginOptions$includ = pluginOptions.include_favicon) !== null &&
    _pluginOptions$includ !== void 0
      ? _pluginOptions$includ
      : true;
  pluginOptions.legacy =
    (_pluginOptions$legacy = pluginOptions.legacy) !== null &&
    _pluginOptions$legacy !== void 0
      ? _pluginOptions$legacy
      : true;
  pluginOptions.theme_color_in_head =
    (_pluginOptions$theme_ = pluginOptions.theme_color_in_head) !== null &&
    _pluginOptions$theme_ !== void 0
      ? _pluginOptions$theme_
      : true;
  pluginOptions.cacheDigest = null;

  if (pluginOptions.cache_busting_mode !== "none" && pluginOptions.icon) {
    pluginOptions.cacheDigest = (0, _gatsbyCoreUtils.createContentDigest)(
          ...
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              (localize = _ref2.localize),
                (manifest = (0, _objectWithoutPropertiesLoose2.default)(_ref2, [
                  "localize"
                ]));
            ...
            case 7:
              ...
              */
                  ...
                  if (
                    locale.hasOwnProperty("icon") &&
                    !locale.hasOwnProperty("icons")
                  ) {
                  ...
                  return makeManifest({
                    cache: cache,
                    reporter: reporter,
                    pluginOptions: (0, _extends2.default)(
                      (0, _extends2.default)(
                        (0, _extends2.default)({}, manifest),
                        locale
                      ),
                      cacheModeOverride
                    ),
...
var makeManifest = /*#__PURE__*/ (function() {
  var _ref5 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee3(_ref4) {
      var _pluginOptions$includ2;

      var cache,
        reporter,
        pluginOptions,
        _ref4$shouldLocalize,
        shouldLocalize,
        _ref4$basePath,
        basePath,
        icon,
          ...
          switch ((_context3.prev = _context3.next)) {
            case 0:
              (cache = _ref4.cache),
                ...
                (_ref4$shouldLocalize = _ref4.shouldLocalize),
                (shouldLocalize =
                  _ref4$shouldLocalize === void 0
                    ? false
                    : _ref4$shouldLocalize),
                (_ref4$basePath = _ref4.basePath),
                (basePath = _ref4$basePath === void 0 ? "" : _ref4$basePath);
              ...
              suffix =
                shouldLocalize && pluginOptions.lang
                  ? "_" + pluginOptions.lang
                  : "";
              faviconIsEnabled =
                (_pluginOptions$includ2 = pluginOptions.include_favicon) !==
                  null && _pluginOptions$includ2 !== void 0
                  ? _pluginOptions$includ2
                  : true; // Delete options we won't pass to the manifest.webmanifest.
              ...
              if (pluginOptions.icon_options) {
                manifest.icons = manifest.icons.map(function(icon) {
                  return (0,
                  _extends2.default)((0, _extends2.default)({}, pluginOptions.icon_options), icon);
                });
                          ...
                          case 3:
                            if (cacheMode !== "none") {
                              iconSet = iconSet.map(function(icon) {
                                ...
                                newIcon.src = (0, _common.addDigestToPath)(
                                  icon.src,
                                  iconDigest,
                                  cacheMode
                                );
            ...
            case 22:
              ...
              if (metadata.width !== metadata.height) {
                reporter.warn(
                  "The icon(" +
                    icon +
                    ") you provided to 'gatsby-plugin-manifest' is not square.\n" +
              ...
              cacheMode =
                typeof pluginOptions.cache_busting_mode !== "undefined"
                  ? pluginOptions.cache_busting_mode
                  : "query";
              iconDigest = (0, _gatsbyCoreUtils.createContentDigest)(
            ...
            case 32:
              ...
              manifest.icons = manifest.icons.map(function(icon) {
                return (0, _extends2.default)(
                  (0, _extends2.default)({}, icon),
                  {},
                  {
                    src: (0, _gatsbyCoreUtils.slash)(
                      path.join(basePath, icon.src)
                    )
                  }
                );
              });
