...
var _webpackAssetsManifest = _interopRequireDefault(
  require("webpack-assets-manifest")
);

var _pluginData = _interopRequireDefault(require("./plugin-data"));

var _buildHeadersProgram = _interopRequireDefault(
...
exports.onCreateWebpackConfig = ({ actions, stage }) => {
  if (
    stage !== _constants.BUILD_HTML_STAGE &&
    stage !== _constants.BUILD_CSS_STAGE
  ) {
    return;
  }
...
exports.onPostBuild = async (
  ...
  const pluginData = (0, _pluginData.default)(
    store,
    assetsManifest,
    pathPrefix
  );
  const pluginOptions = { ..._constants.DEFAULT_OPTIONS, ...userPluginOptions };
  ...
  await Promise.all([
    (0, _buildHeadersProgram.default)(pluginData, pluginOptions, reporter),
    (0, _createRedirects.default)(pluginData, redirects, rewrites)
  ]);
};
