...
const getPackageManager = () =>
  (0, _gatsbyCoreUtils.getConfigStore)().get(packageMangerConfigKey);

exports.getPackageManager = getPackageManager;

const setPackageManager = packageManager => {
  (0, _gatsbyCoreUtils.getConfigStore)().set(
    packageMangerConfigKey,
    packageManager
  );

  _reporter.default.info(
    `Preferred package manager set to "${packageManager}"`
  );
};
