...
var _constructError = _interopRequireDefault(
  require("../structured-errors/construct-error")
);
...
class Reporter {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "success", text =>
      reporterActions.createLog({
        level: _constants.LogLevels.Success,
        text
      })
    );
    (0, _defineProperty2.default)(this, "info", text =>
      reporterActions.createLog({
        level: _constants.LogLevels.Info,
        text
      })
    );
    (0, _defineProperty2.default)(this, "warn", text =>
      reporterActions.createLog({
        level: _constants.LogLevels.Warning,
        text
      })
    );
    (0, _defineProperty2.default)(this, "log", text =>
      reporterActions.createLog({
    ...
    (0, _defineProperty2.default)(
      this,
      "completeActivity",
      (id, status = _constants.ActivityStatuses.Success) => {
    ...
    (0, _defineProperty2.default)(
      this,
      "createProgress",
      (text, total = 0, start = 0, activityArgs = {}) => {
        let { parentSpan, id, tags } = activityArgs;
        const spanArgs = parentSpan
          ? {
              childOf: parentSpan,
