...
const ActivityStatusToLogLevel = {
  [_constants.ActivityStatuses.Interrupted]:
    _constants.ActivityLogLevels.Interrupted,
      ...
      actionsToEmit.push(
        createLog({
          ...
          statusText:
            ...
            activity.type === _constants.ActivityTypes.Progress
...
const setActivityStatusText = ({ id, statusText }) =>
  updateActivity({
    id,
    statusText
  });
...
const setActivityTotal = ({ id, total }) =>
  updateActivity({
    id,
    total
  });
