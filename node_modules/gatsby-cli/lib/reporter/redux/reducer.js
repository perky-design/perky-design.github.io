...
const reducer = (
  ...
  switch (action.type) {
    ...
    case _constants.Actions.StartActivity: {
      ...
      return {
        ...state,
        activities: { ...state.activities, [id]: action.payload }
      };
    }
    ...
    case _constants.Actions.PendingActivity: {
      ...
      return {
        ...state,
        activities: { ...state.activities, [id]: { ...activity, ...rest } }
      };
    }
    ...
    case _constants.Actions.CancelActivity: {
      ...
      activities[id] = { ...activity, status, duration };
