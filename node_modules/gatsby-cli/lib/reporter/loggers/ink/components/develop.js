...
const useTerminalResize = () => {
  const { stdout } = (0, _react.useContext)(_ink.StdoutContext);
...
const Develop = ({ pagesCount, appName, status }) => {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(_ink.Color, null, status),
      /*#__PURE__*/ _react.default.createElement(_ink.Box, {
        flexGrow: 1
      }),
...
const ConnectedDevelop = () => {
  ...
  return /*#__PURE__*/ _react.default.createElement(Develop, {
    pagesCount:
      ((_state$pages = state.pages) === null || _state$pages === void 0
        ? void 0
        : _state$pages.size) || 0,
    appName:
      ((_state$program = state.program) === null || _state$program === void 0
        ? void 0
        : _state$program.sitePackageJson.name) || ``,
    status:
      ((_state$logs = state.logs) === null || _state$logs === void 0
        ? void 0
        : _state$logs.status) || ``
  });
};
