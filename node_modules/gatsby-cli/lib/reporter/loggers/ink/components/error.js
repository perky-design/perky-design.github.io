...
const File = ({ filePath, location }) => {
  const lineNumber =
    location === null || location === void 0 ? void 0 : location.start.line;
  let locString = ``;

  if (typeof lineNumber !== `undefined`) {
    locString += `:${lineNumber}`;
    const columnNumber =
      location === null || location === void 0 ? void 0 : location.start.column;
...
const Error = _react.default.memo(({ details }) =>
  /*#__PURE__*/
