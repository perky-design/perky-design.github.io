...
if (_os.default.platform() === `win32`) {
  (0,
  _ensureWindowsDriveLetterIsUppercase.ensureWindowsDriveLetterIsUppercase)();
...
if (
  !_semver.default.satisfies(version, `>=${MIN_NODE_VERSION}`, {
    includePrerelease: true
  })
) {
  _reporter.default.panic(
    _reporter.default.stripIndent(`
